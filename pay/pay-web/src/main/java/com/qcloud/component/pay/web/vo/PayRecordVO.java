package com.qcloud.component.pay.web.vo;
...
public class PayRecordVO {
	...
	public PayRecordVO(long id,String orderNumber,long orderId,Date orderDate,String tradeId,int tradeTyped,String sum,Date time){
		this.id = id;		
