...
public class MerchandiseDealRecordVO {
	...
	public MerchandiseDealRecordVO(long id,long merchandiseId,long userId,int number,String specifications,Date time,long orderId,long subOrderId,long orderItemId,long orderItemDetailId){
		this.id = id;		
