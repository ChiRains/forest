...
<div class="row">
    <div class="col-xs-12">
        <!-- PAGE CONTENT BEGINS -->
        <form id="groupbuys-form" class="form-horizontal"  role="form" action="/admin/merchandiseItem/add.do">
            ...
            <div class="clearfix form-actions">
                <div class="col-md-offset-3 col-md-9">
                    ...
                    &nbsp; &nbsp; &nbsp;
                    <button class="btn" type="button" onclick="window.location.href='#admin/merchandiseItem/list'">
	                        ...
	                        if (obj.hasClass("add-btn")) {
	                            ...
	                            if (name) {
	                                ...
	                                count >= 0 && $("#productList").append(
	                                        ...
	                                        '<input type="hidden" name="merchandiseItemsIds[]" value="' + merchandiseItemsIds + '" readonly class="config-key"> ' + 
	                                        '<td><input type="text" value="' + name + '" readonly class="config-value"></td>' +
	                                        '<td><input type="text"  name="stock[]" value="' + stock + '" readonly class="config-value"></td>'+
	                                        '<td><input type="text" name="purchase[]" value="' + purchase + '" class="config-value"></td>' +
	                                        '<td><input type="text" name="price[]" value="' + price + '" class="config-value"></td>' +
