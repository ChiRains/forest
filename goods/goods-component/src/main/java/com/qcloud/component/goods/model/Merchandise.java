...
public class Merchandise {
    ...
    public Merchandise(long id, long merchantClassifyId, long mallClassifyId, long specClassifyId, long merchantId, String name, String sysCode, String image, String keywords, int weight, int state, String unit, String details, String desc, int isCertified, int isSpecialService, int isNoReason, int isExternalUrl, String certified, String specialService, String noReason, String externalUrl, int isIncludePost, long brandId, String label) {
