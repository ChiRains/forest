...
public class CombinationMerchandiseDaoCacheImpl implements CombinationMerchandiseDao {
	...
	public CombinationMerchandise get(Long id) {
		return CacheLoader.get(combinationMerchandiseDaoRedisImpl, combinationMerchandiseDaoMysqlImpl, id);
	}
	...
	public List<CombinationMerchandise> list(List<Long> idList) {
		return CacheLoader.list(combinationMerchandiseDaoRedisImpl, combinationMerchandiseDaoMysqlImpl, idList);
	}

	@Override
	public Map<Long, CombinationMerchandise> map(Set<Long> idSet){
		return CacheLoader.map(combinationMerchandiseDaoRedisImpl, combinationMerchandiseDaoMysqlImpl, idSet);
	}
