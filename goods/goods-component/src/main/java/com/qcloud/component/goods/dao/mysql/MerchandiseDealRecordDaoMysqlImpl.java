...
public class MerchandiseDealRecordDaoMysqlImpl implements MerchandiseDealRecordDao {
    ...
    public boolean add(MerchandiseDealRecord merchandiseDealRecord) {
        ...
        return sqlOperator.insert("com.qcloud.component.goods.dao.mysql.mapper.MerchandiseDealRecordMapper.insert", map) == 1;
    }
    ...
    public Page<MerchandiseDealRecord> page(int start, int count) {
        ...
        List<MerchandiseDealRecord> list = sqlOperator.selectList("com.qcloud.component.goods.dao.mysql.mapper.MerchandiseDealRecordMapper.list4page", param);
        int total = sqlOperator.selectOne("com.qcloud.component.goods.dao.mysql.mapper.MerchandiseDealRecordMapper.count4page", param);
    ...
    public Page<MerchandiseDealRecord> page(MerchandiseDealRecordQuery query, int start, int count) {
        ...
        param.put("start", start);
        param.put("count", count);
        List<MerchandiseDealRecord> list = sqlOperator.selectList("com.qcloud.component.goods.dao.mysql.mapper.MerchandiseDealRecordMapper.list4query", param);
        int total = sqlOperator.selectOne("com.qcloud.component.goods.dao.mysql.mapper.MerchandiseDealRecordMapper.count4query", param);
        Page<MerchandiseDealRecord> page = new Page<MerchandiseDealRecord>();
        page.setCount(total);
        page.setData(list);
        return page;
    ...
    public List<MerchandiseDealRecord> listAll() {
        ...
        List<MerchandiseDealRecord> list = sqlOperator.selectList("com.qcloud.component.goods.dao.mysql.mapper.MerchandiseDealRecordMapper.listAll");
        return list;
    }
    ...
    public List<MerchandiseDealRecord> listByMerchandise(Long merchandiseId, int start, int count) {
        ...
        List<MerchandiseDealRecord> list = sqlOperator.selectList("com.qcloud.component.goods.dao.mysql.mapper.MerchandiseDealRecordMapper.listByMerchandise", param);
        return list;
    }

    private String getTableName(long userId) {

        return TableSplitUtil.getTableSplitName(userId, "goods_merchandise_deal_record", 100);
    }
}
