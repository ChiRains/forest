...
public interface MerchandiseMapper {
	...
	@Insert("insert into `goods_merchandise`(`id`,`merchantClassifyId`,`mallClassifyId`,`specClassifyId`,`merchantId`,`name`,`sysCode`,`code`,`image`,`keywords`,`weight`,`state`,`unit`,`details`,`desc`,`isCertified`,`isSpecialService`,`isNoReason`,`isExternalUrl`,`certified`,`specialService`,`noReason`,`externalUrl`,`isIncludePost`,`brandId`)"
