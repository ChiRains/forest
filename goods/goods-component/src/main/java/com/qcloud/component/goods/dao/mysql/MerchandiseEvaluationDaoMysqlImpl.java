...
public class MerchandiseEvaluationDaoMysqlImpl implements MerchandiseEvaluationDao {
    ...
    public boolean add(MerchandiseEvaluation merchandiseEvaluation) {
        ...
        return sqlOperator.insert("com.qcloud.component.goods.dao.mysql.mapper.MerchandiseEvaluationMapper.insert", param) == 1;
    }
    ...
    public MerchandiseEvaluation get(Long evaluationId, Long merchandiseId) {
        ...
        return sqlOperator.selectOne("com.qcloud.component.goods.dao.mysql.mapper.MerchandiseEvaluationMapper.get", map);
    }
    ...
    public boolean delete(Long id, Long merchandiseId) {
        ...
        param.put("id", id);
        return sqlOperator.delete("com.qcloud.component.goods.dao.mysql.mapper.MerchandiseEvaluationMapper.deleteByMerchandiseId", param) > 0;
    }
    ...
    public boolean update(MerchandiseEvaluation merchandiseEvaluation) {
        ...
        Map<String, Object> param = BeanUtils.transBean2Map(merchandiseEvaluation);
        param.put("table_name", getTableName(merchandiseEvaluation.getMerchandiseId()));
        return sqlOperator.update("com.qcloud.component.goods.dao.mysql.mapper.MerchandiseEvaluationMapper.update", param) > 0;
    }
    ...
    public Page<MerchandiseEvaluation> page(MerchandiseEvaluationQuery query, int start, int count) {
        ...
        List<MerchandiseEvaluation> list = sqlOperator.selectList("com.qcloud.component.goods.dao.mysql.mapper.MerchandiseEvaluationMapper.list4query", param);
        int total = sqlOperator.selectOne("com.qcloud.component.goods.dao.mysql.mapper.MerchandiseEvaluationMapper.count4query", param);
    ...
    private String getTableName(long merchandiseId) {
        ...
        return TableSplitUtil.getTableSplitName(merchandiseId, "goods_merchandise_evaluation", 100);
    }
    ...
    public Page<MerchandiseEvaluation> page(long merchandiseId, StarLevelType starLevelType, int start, int count) {
        ...
        param.put("star", star);
        param.put("nextStar", nextStar);
        List<MerchandiseEvaluation> list = sqlOperator.selectList("com.qcloud.component.goods.dao.mysql.mapper.MerchandiseEvaluationMapper.list", param);
        int total = sqlOperator.selectOne("com.qcloud.component.goods.dao.mysql.mapper.MerchandiseEvaluationMapper.count", param);
        Page<MerchandiseEvaluation> page = new Page<MerchandiseEvaluation>();
        page.setCount(total);
        page.setData(list);
        return page;
