...
public class MerchandiseVipDiscountHistoryVO {
	...
	public MerchandiseVipDiscountHistoryVO(){
	
	}

	public MerchandiseVipDiscountHistoryVO(long id,long userId,long merchandiseItemId,double price,double discount,int paymentType,double priceHistory,double discountHistory,int paymentTypeHistory,Date updateTime){
		this.id = id;		
		this.userId = userId;		
