...
public class MonthHotSaleVO {
	...
	public MonthHotSaleVO(long id,long mallClassifyId,String mallBsid,long unifiedMerchandiseId,int number,int year,int month,long merchantClassifyId,String merchantBsid){
		this.id = id;		
