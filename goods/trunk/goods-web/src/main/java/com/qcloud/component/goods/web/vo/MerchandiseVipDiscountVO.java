...
public class MerchandiseVipDiscountVO {
	...
	public MerchandiseVipDiscountVO(){
	
	}

	public MerchandiseVipDiscountVO(long id,long userId,long merchandiseItemId,double price,int discount,int paymentType,long classifyId,String classifyBSID){
		this.id = id;		
		this.userId = userId;		
