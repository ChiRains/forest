...
public class MerchandiseVipDiscountHistoryDaoMysqlImpl implements MerchandiseVipDiscountHistoryDao {
	...
	public Page<MerchandiseVipDiscountHistory> page(int start, int count){
		...
		List<MerchandiseVipDiscountHistory> list = sqlOperator.selectList(
				"com.qcloud.component.goods.dao.mysql.mapper.MerchandiseVipDiscountHistoryMapper.list4page",
				param);
		int total = sqlOperator.selectOne(
				"com.qcloud.component.goods.dao.mysql.mapper.MerchandiseVipDiscountHistoryMapper.count4page",
				param);
	...
	public Page<MerchandiseVipDiscountHistory> page(MerchandiseVipDiscountHistoryQuery query, int start, int count){
		...
		List<MerchandiseVipDiscountHistory> list = sqlOperator.selectList(
				"com.qcloud.component.goods.dao.mysql.mapper.MerchandiseVipDiscountHistoryMapper.list4query",
				param);
		int total = sqlOperator.selectOne(
				"com.qcloud.component.goods.dao.mysql.mapper.MerchandiseVipDiscountHistoryMapper.count4query",
				param);
		Page<MerchandiseVipDiscountHistory> page = new Page<MerchandiseVipDiscountHistory>();
		page.setCount(total);
		page.setData(list);
	...
	public List<MerchandiseVipDiscountHistory> listAll(){	
		List<MerchandiseVipDiscountHistory> list = sqlOperator.selectList(
				"com.qcloud.component.goods.dao.mysql.mapper.MerchandiseVipDiscountHistoryMapper.listAll");
		return list;
	}
}
