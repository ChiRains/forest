...
public class MerchandiseVipDiscountDateDaoCacheImpl implements MerchandiseVipDiscountDateDao {
	...
	public List<MerchandiseVipDiscountDate> list(List<Long> idList) {
		return CacheLoader.list(merchandiseVipDiscountDateDaoRedisImpl, merchandiseVipDiscountDateDaoMysqlImpl, idList);
	}

	@Override
	public Map<Long, MerchandiseVipDiscountDate> map(Set<Long> idSet){
		return CacheLoader.map(merchandiseVipDiscountDateDaoRedisImpl, merchandiseVipDiscountDateDaoMysqlImpl, idSet);
	}
