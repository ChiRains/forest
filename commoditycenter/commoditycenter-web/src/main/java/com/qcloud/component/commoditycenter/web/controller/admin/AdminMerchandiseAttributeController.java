...
public class AdminMerchandiseAttributeController {
	...
	public ModelAndView list(Integer pageNum, MerchandiseAttributeQuery query) {
		...
		AcePagingView pagingView = new AcePagingView("/admin/commoditycenter-MerchandiseAttribute-list", DIR
	...
	public ModelAndView toAdd() {
		ModelAndView model = new ModelAndView("/admin/commoditycenter-MerchandiseAttribute-add");
		return model;
	}
	...
	public ModelAndView toEdit(Long id) {
		...
		ModelAndView model = new ModelAndView("/admin/commoditycenter-MerchandiseAttribute-edit");
