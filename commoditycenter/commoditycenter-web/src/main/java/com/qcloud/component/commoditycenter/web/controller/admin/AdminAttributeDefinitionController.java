...
public class AdminAttributeDefinitionController {
    ...
    public ModelAndView list(Integer pageNum, AttributeDefinitionQuery query) {
        ...
        AcePagingView pagingView = new AcePagingView("/admin/commoditycenter-AttributeDefinition-list", DIR + "/list", pageNum, PAGE_SIZE, page.getCount());
    ...
    public ModelAndView toAdd() {
        ModelAndView model = new ModelAndView("/admin/commoditycenter-AttributeDefinition-add");
        return model;
    }
    ...
    public ModelAndView toEdit(Long id) {
        ...
        ModelAndView model = new ModelAndView("/admin/commoditycenter-AttributeDefinition-edit");
    ...
    public AcePagingView specList(Integer pageNum, AttributeDefinitionQuery query){
        ...
        Page<AttributeDefinition> page = attributeDefinitionService.page(query, start, PAGE_SIZE);
        List<AdminAttributeDefinitionVO> list = attributeDefinitionHandler.toVOList4Admin(page.getData());
        AcePagingView pagingView = new AcePagingView("/admin/commoditycenter-AttributeDefinition-speclist", DIR + "/specList", pageNum, PAGE_SIZE, page.getCount());
        pagingView.addObject("result", list);
        return pagingView;
    }
    ...
    public ModelAndView toAddSpec(){
        ...
        ModelAndView model = new ModelAndView("/admin/commoditycenter-AttributeDefinition-addspec");
    ...
    public ModelAndView toEditSpec(Long id){
        ...
        AssertUtil.assertNotNull(id, "id不能为空");
        AttributeDefinition attributeDefinition=attributeDefinitionService.get(id);
        ModelAndView model = new ModelAndView("/admin/commoditycenter-AttributeDefinition-editspec");
    ...
    public AcePagingView selectAttribute(Integer pageNum,AttributeDefinitionQuery query){
        ...
        List<AdminAttributeDefinitionVO> list = attributeDefinitionHandler.toVOList4Admin(page.getData());
        AcePagingView pagingView = new AcePagingView("/admin/commoditycenter-AttributeDefinition-list4Select", 
