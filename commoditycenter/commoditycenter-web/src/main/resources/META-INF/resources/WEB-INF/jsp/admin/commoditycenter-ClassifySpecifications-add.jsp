    ...
    <div class="col-xs-12">
        ...
        <form id="model-form" class="form-horizontal" role="form" action="/admin/classifySpecifications/add.do">
            ...
            <div class="form-group">
                <label class="col-sm-3 control-label no-padding-right" for="classifyId"> 分类 </label>
            ...
            <div class="form-group">
                ...
                <div class="col-sm-9">
					<span class="col-sm-5 no-padding block input-icon input-icon-right mr10">
					<input  value="" class="width-100" readonly name="attributeId" id="attributeId" />
					</span>
                </div>
            </div>
            <div class="space-4"></div>
            <div class="form-group">
                ...
                <div class="col-sm-9">
					<span class="col-sm-5 no-padding block input-icon input-icon-right mr10">
						<input type="hidden" id="uploadImage" name="uploadImage" value="2"/>
                    	<input id="uploadImage-c" type="checkbox" class="ace ace-switch ace-switch-5 ace-switch-uploadImage" name="uploadImage-c"/>
...
<script type="text/javascript">
    ...
    ace.load_ajax_scripts(scripts, function () {
        ...
        jQuery(function ($) {
            ...
            $(".ace-switch-uploadImage").on('change', function () {
                var el = $(this);
                $("#uploadImage").val(el[0].checked ? '1' : '2');
                // alert($("#soup").val());
            });
