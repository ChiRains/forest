...
<div class="row">
    <div class="col-xs-12">
        ...
        <form id="model-form" class="form-horizontal"  role="form" action="/admin/classifySpecifications/edit.do">
            ...
            <input type="hidden" name="classifyId" value="${classifySpecifications.classifyId}"/>
                  		<div class="space-4"></div>
            <div class="form-group">
                <label class="col-sm-3 control-label no-padding-right" for="classifyId"> 分类定义 </label>
                <div class="col-sm-9">
					<span class="col-sm-5 no-padding block input-icon input-icon-right mr10">
						 <input  value="${classify.name}" class="width-100" readonly name="" id="" />
					</span>
                </div>
            </div>
            ...
            <div class="form-group">
                ...
                <div class="col-sm-9">
					<span class="col-sm-5 no-padding block input-icon input-icon-right mr10">
					<input  value="${classifySpecifications.attributeId}" class="width-100" readonly name="attributeId" id="attributeId" />
					</span>
                </div>
            </div>
            ...
            <div class="form-group">
                ...
                <div class="col-sm-9">
					<span class="col-sm-5 no-padding block input-icon input-icon-right mr10">									
						<input type="hidden"  id="uploadImage" name="uploadImage" value="${classifySpecifications.uploadImage}"/>
                    	<input id="calculatePrice-c" type="checkbox" class="ace ace-switch ace-switch-5 ace-switch-calculatePrice" name="calculatePrice-c" ${classifySpecifications.uploadImageChecked}/>
        ...
        jQuery(function ($) {
            ...
            $("#search-button").on("click", function () {
	                BootstrapDialog.show({
	                    title: "属性列表",
	                    message: $('<div></div>').load('/admin/attributeDefinition/selectAttribute.do?pageNum=1&type=2'),
