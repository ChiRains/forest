...
<div class="row">
    <div class="col-xs-12">
        ...
        <form id="model-form" class="form-horizontal"  role="form" action="/admin/screeningsSlide/edit.do">
			...
			<input type="hidden" name="screeningsId" value="${screeningsSlide.screeningsId}">
            ...
            <div class="form-group">
                ...
                <div class="col-sm-9">
					<input type="hidden"  id="image" name="image" value="${screeningsSlide.image}" onchange="fileChange(this);"/>
                    ...
                    <ul sid="image" id="pic-pic-view2" class="ace-thumbnails clearfix">
                        <li pic-id="">
                            <a style="line-height: 150px;text-align: center;width:150px;height: 150px;" href="" data-rel="colorbox" class="cboxElement">
                                <img style="max-height: 150px;max-width: 150px;" alt="" src="${screeningsSlide.image}">
                            </a>
            ...
            <div class="form-group">
                ...
                <div class="col-sm-9">
					<span class="col-sm-5 no-padding block input-icon input-icon-right mr10">
						<input type="text" class="width-100" maxlength="20" id="orderNum" name="orderNum" placeholder="排序" value="${screeningsSlide.orderNum}" onkeyup="value=value.replace(/[^\d]/g,'') " />
						<i class="ace-icon fa"></i>
					</span>
                </div>
            </div>
