...
public class RangeGradeDaoMysqlImpl implements RangeGradeDao {
    ...
    public Page<RangeGrade> page(int start, int count) {
        ...
        List<RangeGrade> list = sqlOperator.selectList("com.qcloud.project.forest.dao.mysql.mapper.RangeGradeMapper.list4page", param);
        int total = sqlOperator.selectOne("com.qcloud.project.forest.dao.mysql.mapper.RangeGradeMapper.count4page", param);
    ...
    public Page<RangeGrade> page(RangeGradeQuery query, int start, int count) {
        ...
        param.put("start", start);
        param.put("count", count);
        param.put("rangeId", query.getRangeId());
        List<RangeGrade> list = sqlOperator.selectList("com.qcloud.project.forest.dao.mysql.mapper.RangeGradeMapper.list4query", param);
        int total = sqlOperator.selectOne("com.qcloud.project.forest.dao.mysql.mapper.RangeGradeMapper.count4query", param);
        Page<RangeGrade> page = new Page<RangeGrade>();
        page.setCount(total);
        page.setData(list);
        return page;
