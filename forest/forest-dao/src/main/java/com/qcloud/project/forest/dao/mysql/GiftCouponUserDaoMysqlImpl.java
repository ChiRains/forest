...
public class GiftCouponUserDaoMysqlImpl implements GiftCouponUserDao {
	...
	public Page<GiftCouponUser> page(int start, int count){
		...
		List<GiftCouponUser> list = sqlOperator.selectList(
				"com.qcloud.project.forest.dao.mysql.mapper.GiftCouponUserMapper.list4page",
				param);
		int total = sqlOperator.selectOne(
				"com.qcloud.project.forest.dao.mysql.mapper.GiftCouponUserMapper.count4page",
				param);
	...
	public Page<GiftCouponUser> page(GiftCouponUserQuery query, int start, int count){
		...
		List<GiftCouponUser> list = sqlOperator.selectList(
				"com.qcloud.project.forest.dao.mysql.mapper.GiftCouponUserMapper.list4query",
				param);
		int total = sqlOperator.selectOne(
				"com.qcloud.project.forest.dao.mysql.mapper.GiftCouponUserMapper.count4query",
				param);
		Page<GiftCouponUser> page = new Page<GiftCouponUser>();
		page.setCount(total);
		page.setData(list);
	...
	public List<GiftCouponUser> listAll(){	
		List<GiftCouponUser> list = sqlOperator.selectList(
				"com.qcloud.project.forest.dao.mysql.mapper.GiftCouponUserMapper.listAll");
		return list;
	}
}
