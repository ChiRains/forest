...
public class GiftCouponDaoMysqlImpl implements GiftCouponDao {
    ...
    public Page<GiftCoupon> page(int start, int count) {
        ...
        List<GiftCoupon> list = sqlOperator.selectList("com.qcloud.project.forest.dao.mysql.mapper.GiftCouponMapper.list4page", param);
        int total = sqlOperator.selectOne("com.qcloud.project.forest.dao.mysql.mapper.GiftCouponMapper.count4page", param);
    ...
    public Page<GiftCoupon> page(GiftCouponQuery query, int start, int count) {
        ...
        param.put("start", start);
        param.put("count", count);
        List<GiftCoupon> list = sqlOperator.selectList("com.qcloud.project.forest.dao.mysql.mapper.GiftCouponMapper.list4query", param);
        int total = sqlOperator.selectOne("com.qcloud.project.forest.dao.mysql.mapper.GiftCouponMapper.count4query", param);
        Page<GiftCoupon> page = new Page<GiftCoupon>();
        page.setCount(total);
        page.setData(list);
        return page;
    ...
    public List<GiftCoupon> listAll() {
        ...
        List<GiftCoupon> list = sqlOperator.selectList("com.qcloud.project.forest.dao.mysql.mapper.GiftCouponMapper.listAll");
        return list;
    }
}
