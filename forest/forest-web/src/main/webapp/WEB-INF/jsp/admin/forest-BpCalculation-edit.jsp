...
<div class="row">
    <div class="col-xs-12">
        <!-- PAGE CONTENT BEGINS -->
        <form id="model-form" class="form-horizontal"  role="form" action="/admin/bpCalculation/edit.do">
            <!-- #section:elements.form -->
			<input type="hidden" name="id" value="${bpCalculation.id}">
            ...
            <div class="form-group">
                ...
                <div class="col-sm-9">
					<span class="col-sm-5 no-padding block input-icon input-icon-right mr10">
						<input type="text" class="width-100" maxlength="20" id="name" name="name" placeholder="名称" value="${bpCalculation.name}"/>
            ...
            <div class="form-group">
                ...
                <div class="col-sm-9">
					<span class="col-sm-5 no-padding block input-icon input-icon-right mr10">
						<textarea style="width:600px;height: 300px;" class="col-xs-10 no-float" id="description" name="description">${bpCalculation.description}</textarea>
						<i class="ace-icon fa"></i>
					</span>
                </div>
            </div>
            ...
            <div class="form-group">
                ...
                <div class="col-sm-9">
					<span class="col-sm-5 no-padding block input-icon input-icon-right mr10">
						<input type="text" class="width-100" maxlength="20" id="dbpMax" name="dbpMax" placeholder="搜索呀最大值" value="${bpCalculation.dbpMax}"/>
						<i class="ace-icon fa"></i>
					</span>
                </div>
            </div>
            ...
            <div class="form-group">
                ...
                <div class="col-sm-9">
					<span class="col-sm-5 no-padding block input-icon input-icon-right mr10">
						<input type="text" class="width-100" maxlength="20" id="dbpMin" name="dbpMin" placeholder="收缩压最小值" value="${bpCalculation.dbpMin}"/>
						<i class="ace-icon fa"></i>
					</span>
                </div>
            </div>
            ...
            <div class="form-group">
                ...
                <div class="col-sm-9">
					<span class="col-sm-5 no-padding block input-icon input-icon-right mr10">
						<input type="text" class="width-100" maxlength="20" id="sdpMax" name="sdpMax" placeholder="舒张压最大值" value="${bpCalculation.sdpMax}"/>
						<i class="ace-icon fa"></i>
					</span>
                </div>
            </div>
            ...
            <div class="form-group">
                ...
                <div class="col-sm-9">
					<span class="col-sm-5 no-padding block input-icon input-icon-right mr10">
						<input type="text" class="width-100" maxlength="20" id="sdpMin" name="sdpMin" placeholder="舒张压最小值" value="${bpCalculation.sdpMin}"/>
						<i class="ace-icon fa"></i>
					</span>
                </div>
            </div>
