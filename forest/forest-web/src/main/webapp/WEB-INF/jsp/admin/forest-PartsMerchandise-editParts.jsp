...
<div class="row">
    <div class="col-xs-12">
        <!-- PAGE CONTENT BEGINS -->
        <form id="model-form" class="form-horizontal"  role="form" action="/admin/partsMerchandise/editParts.do">
            <!-- #section:elements.form -->
			<input type="hidden" name="classifyId" value="${classify.id}">
			
      		<div class="space-4"></div>
            <div class="form-group">
                <label class="col-sm-3 control-label no-padding-right" for=""> 部位 </label>
                <div class="col-sm-9">
					<span class="col-sm-5 no-padding block input-icon input-icon-right mr10">
						<input type="text" class="width-100" id="name" name="name" value="${classify.name}"/>
