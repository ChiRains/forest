                ...
                <div class="row">
                    <div class="col-xs-6">
                        <div class="dataTables_length">
                            <a title="新增" class="btn btn-sm btn-info"
                               href="#admin/salesPromotion/toAddClassifyForMallCustom">
                    ...
                    <div class="col-xs-6">
	                    <div class="text-right">
	                        <label>
	                            <form action="#admin/salesPromotion/mallList" onsubmit="listFormSearch(this); return false">
	                               <div class="dataTables_length">
	                               			分类
                            ...
                            <tr>            
                                ...
                                <div class="hidden-sm hidden-xs action-buttons">
                                    <a title="删除" class="red del-item-new" href="javascript:;"
                                       api-path="/admin/salesPromotion/deleteMall.do?id=${item.id}">
