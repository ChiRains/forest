...
@Controller
@RequestMapping(value = HomepageSalesController.DIR)
public class HomepageSalesController {

    public static final String        DIR = "/homepageSales";
    ...
    @PiratesApp
    @RequestMapping
    public FrontAjaxView getHomepageSalesClassify() {

        List<Classify> classifies = publicdataClient.listClassify((long) ClassifyType.HOMEPAGESALECLASSIFY.getKey());
    ...
    @PiratesApp
    @RequestMapping
    public FrontPagingView getHomepageSaleslist(PPage pPage, Long classifyId) {
