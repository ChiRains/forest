...
public class MedicationRemindersVO {
	...
	public MedicationRemindersVO(long id,long userId,long themeId,String medicineName,long medicineId,int medicineDosage,String medicineUnit,String periodTimes,String useTimes,String desc,Date recordTime){
		this.id = id;		
		this.userId = userId;		
