...
public class Medication {
	...
	public Medication(long id,String theme,String image,String medicine,String objectName,int dosage,String unit,String desc,int enable,long userId,Date recordTime){
		this.id = id;		
		this.theme = theme;		
		this.image = image;		
