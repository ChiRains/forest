...
<!--                     <div class="col-xs-6">
                        <div class="dataTables_length">
                            <a title="新增" class="btn btn-sm btn-info"
                               href="#admin/myCommissionWithdrawCash/toAdd">
                        ...
                        <label>
                            <form id="query-form" action="#admin/myCommissionWithdrawCash/transferlist" onsubmit="listFormSearch(this); return false">
                            	<div class="dataTables_length">
                            ...
                            <tr>            
                             ...
                             <%--        <a title="修改基本信息" class="green" 
									...
									<a class="btn btn-xs btn-primary passcheck"
											api-path="/admin/myCommissionWithdrawCash/check.do?id=${item.id}&ischeck=3">转账
									</a>
									</c:if>
									<c:if  test="${item.state==2}">
									<a class="btn btn-xs btn-primary notpasscheck"
											api-path="/admin/myCommissionWithdrawCash/check.do?id=${item.id}&ischeck=5">不转账
									</a>
									</c:if>	 							                                 
                                </div>
                            </td>
                         ...
                         $.get(delUrl, {},
                                 function (data) {
                                     ...
                                     if (parseInt(data["status"]) === 0) {
                                         ...
                                         dialogItself.setMessage("转账操作成功！");
