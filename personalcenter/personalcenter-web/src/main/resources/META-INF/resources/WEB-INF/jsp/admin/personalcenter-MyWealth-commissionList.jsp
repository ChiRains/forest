                ...
                <div class="row">
                    <div class="col-xs-6">
                    	<div class="dataTables_length" >
                            <a title="注册送佣金" class="btn btn-sm btn-info"
                               href="#admin/pointConfig/getRegistrationBrokerage">
                    ...
                    <form action="#admin/myWealth/commissionList" id="query-form" onsubmit="listFormSearch(this); return false">
                    <div class="col-xs-6">
