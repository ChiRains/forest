...
public class FormulaCalculationResult {
	...
	public FormulaCalculationResult(long id,long dataPoolId,int type,String name,String image,double brokerage,Date orderTime,long userId,long merchantId,int state,long formulaId,Date calculateTime,Date beginTime,Date endTime){
		this.id = id;		
