        ...
        <div>
            <div class="dataTables_wrapper form-inline no-footer">
                <div class="row">
                    ...
                    <div class="col-xs-6">
	                    <div class="text-right">
	                        <label>
	                            <form action="#admin/merchantOrderForm/storeReportForm" onsubmit="listFormSearch(this); return false">
	                                <div class="dataTables_length">                                          	                            	
		                                   	 查询类型
                ...
                <table class="table table-striped table-bordered table-hover dataTable no-footer">
                    ...
                    <tbody>
                     <c:forEach items="${result}" var="store" varStatus="current"> 
                     		<tr>
								<td colspan="11">
								  <span style="color:green;"> 门店名称 ：</span><strong>${store.name}</strong>&nbsp;&nbsp;&nbsp;&nbsp;
								  <span style="color:green;"> 联系人电话 ：</span><strong>${store.phone}</strong>
								  <span style="float:right;"><a class="btn btn-primary btn-xs open" data-index="${current.index}"><i class="ace-icon bigger-130"></i>展开订单</a></span>
								</td>
							</tr>
							
                           <c:forEach items="${store.merchantOrderFormVOs}" var="item" varStatus="vos"> 
                            <tr class="openTr${current.index}" style="display:none;">                                       
						...
						<tr>
							<td colspan="11" style="text-align: right">订单金额：<span style="color:red;">￥  :  ${store.sum}元 </span>
							</td>
						</tr>
					</c:forEach>
                    </tbody>
...
<script type="text/javascript">
    ...
    ace.load_ajax_scripts(scripts, function () {
        ...
        $(".open").click(function(){
        	...
        	if($(".openTr"+index).is(":hidden")){
        		$(".openTr"+index).show();
        		$(this).html("<i class='ace-icon bigger-130'></i>隐藏订单");
        	}else{
        		$(".openTr"+index).hide();
        		$(this).html("<i class='ace-icon bigger-130'></i>展开订单 ");
        	}
        	//$(".openTr"+index).toggle();
        });
