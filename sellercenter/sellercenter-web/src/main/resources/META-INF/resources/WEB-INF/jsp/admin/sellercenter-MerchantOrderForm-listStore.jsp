                ...
                <div class="row">
                    ...
                    <div class="col-xs-6">
	                    <div class="text-right">
	                        <label>
	                            <form action="#admin/merchantOrderForm/listStore" onsubmit="listFormSearch(this); return false">
	                                <div class="dataTables_length">                                          	                            	
		                                   	 状态
		                                   	 <select class="form-control" id="state" name="state">
	                                        	<option value="0">请选择</option>
	                                         	<c:forEach items="${stateType}" var="stateType" varStatus="current"> 
			                                   		 <option value="${stateType.key}"
			                                   		 <c:if test="${stateType.key eq query.state}">
			                                   		 	 selected="select"
			                                   		 </c:if>>${stateType.name}</option>			                                   		
			                                   	</c:forEach>
			                                </select>
				                      		&nbsp;&nbsp;
