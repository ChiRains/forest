...
<div class="row">
    <div class="col-xs-12">
        <!-- PAGE CONTENT BEGINS -->
        <form id="model-form" class="form-horizontal"  role="form" action="/admin/departmentImage/edit.do">
            <!-- #section:elements.form -->
			<input type="hidden" name="id" value="${departmentImage.id}">
			<input type="hidden" name="departmentId" value="${departmentImage.departmentId}">
                    ...
                    <ul sid="image" id="pic-pic-view2" class="ace-thumbnails clearfix">
                        <li pic-id="">
                            <a style="line-height: 150px;text-align: center;width:150px;height: 150px;" href="" data-rel="colorbox" class="cboxElement">
                                <img style="max-height: 150px;max-width: 150px;" alt="" src="${departmentImage.image}">
                            </a>
                  		...
                  		<div class="space-4"></div>
            <div class="form-group">
                <label class="col-sm-3 control-label no-padding-right" for="orderNum"> 顺序 </label>
                <div class="col-sm-9">
					<span class="col-sm-5 no-padding block input-icon input-icon-right mr10">
						<input type="text" class="width-100" maxlength="20" id="orderNum" name="orderNum" placeholder="顺序" value="${departmentImage.orderNum}" onkeyup="value=value.replace(/[^\d]/g,'') "  />
