...
public class AdminFullReducesVO {
	...
	public AdminFullReducesVO(){
	
	}

	public AdminFullReducesVO(long id,long merchantId,String name,double benefit,double limitPrice,Date beginDate,Date endDate,int canUseCoupon,int canUserSeckill,int state){
		this.id = id;		
