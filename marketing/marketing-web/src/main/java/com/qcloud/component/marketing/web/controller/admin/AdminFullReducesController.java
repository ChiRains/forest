...
public class AdminFullReducesController {
	...
	public ModelAndView list(HttpServletRequest request, Integer pageNum, PPage pPage, FullReducesQuery query) {
		...
		AcePagingView pagingView = new AcePagingView("/admin/marketing-FullReduces-list", DIR
	...
	@RequestMapping
	public AceAjaxView add(FullReduces fullReduces) {
	...
	@RequestMapping
	public AceAjaxView edit(FullReduces fullReduces, String queryStr) {
