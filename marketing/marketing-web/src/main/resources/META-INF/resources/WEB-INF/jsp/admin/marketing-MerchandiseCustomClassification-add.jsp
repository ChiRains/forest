...
<div class="row">
    <div class="col-xs-12">
        <!-- PAGE CONTENT BEGINS -->
        <form id="model-form" class="form-horizontal"  role="form" action="/admin/merchandiseCustomClassification/addClassifyForMerchantCustom.do">
                    ...
                    <table class="table table-striped table-bordered table-hover kv-table">
                        ...
                        <c:forEach items="${voList}" var="item" varStatus="current">
                            <tr class="template kv-table-row">
                                ...
                                <td><input type="text" value="${item.specifications}" readonly class="config-value"></td>
            ...
            <div class="clearfix form-actions">
                <div class="col-md-offset-3 col-md-9">
                    ...
                    &nbsp; &nbsp; &nbsp;
                    <button class="btn" type="button" onclick="window.location.href='#admin/merchandiseCustomClassification/list'">
...
<script type="text/javascript">
    ...
    function change() {
		window.location.href = "#admin/merchandiseCustomClassification/toAddClassifyForMerchantCustom?classifyId="+$("#classifyId").val();
	}
</script>
