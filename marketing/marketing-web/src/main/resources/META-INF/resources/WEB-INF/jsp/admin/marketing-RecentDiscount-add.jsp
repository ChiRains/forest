...
<div class="row">
    <div class="col-xs-12">
        <!-- PAGE CONTENT BEGINS -->
        <form id="model-form" class="form-horizontal"  role="form" action="/admin/recentDiscount/add.do">
            ...
            <div class="form-group">
                ...
                <div class="col-sm-9">
					<span class="col-sm-5 no-padding block input-icon input-icon-right mr10">
						<input type="text" class="width-100" readonly maxlength="20" id="startDate" name="startDate" placeholder="" value=""/>
						<i class="ace-icon fa"></i>
					</span>
                </div>
            </div>
            ...
            <div class="form-group">
                ...
                <div class="col-sm-9">
					<span class="col-sm-5 no-padding block input-icon input-icon-right mr10">
						<input type="text" class="width-100" readonly maxlength="20" id="endDate" name="endDate" placeholder="" value=""/>
						<i class="ace-icon fa"></i>
					</span>
                </div>
            </div>
