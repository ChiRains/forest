...
public class ReturnOrderItemDetailDaoMysqlImpl implements ReturnOrderItemDetailDao {
    ...
    public Page<ReturnOrderItemDetail> page(int start, int count) {
        ...
        List<ReturnOrderItemDetail> list = sqlOperator.selectList("com.qcloud.component.orderform.dao.mysql.mapper.ReturnOrderItemDetailMapper.list4page", param);
        int total = sqlOperator.selectOne("com.qcloud.component.orderform.dao.mysql.mapper.ReturnOrderItemDetailMapper.count4page", param);
    ...
    public Page<ReturnOrderItemDetail> page(ReturnOrderItemDetailQuery query, int start, int count) {
        ...
        param.put("start", start);
        param.put("count", count);
        List<ReturnOrderItemDetail> list = sqlOperator.selectList("com.qcloud.component.orderform.dao.mysql.mapper.ReturnOrderItemDetailMapper.list4query", param);
        int total = sqlOperator.selectOne("com.qcloud.component.orderform.dao.mysql.mapper.ReturnOrderItemDetailMapper.count4query", param);
        Page<ReturnOrderItemDetail> page = new Page<ReturnOrderItemDetail>();
        page.setCount(total);
        page.setData(list);
        return page;
    ...
    public List<ReturnOrderItemDetail> listAll() {
        ...
        List<ReturnOrderItemDetail> list = sqlOperator.selectList("com.qcloud.component.orderform.dao.mysql.mapper.ReturnOrderItemDetailMapper.listAll");
        return list;
    }
    ...
    public List<ReturnOrderItemDetail> listByReturn(long returnId) {
        ...
        List<ReturnOrderItemDetail> list = sqlOperator.selectList("com.qcloud.component.orderform.dao.mysql.mapper.ReturnOrderItemDetailMapper.listByReturn", param);
        return list;
    }
}
