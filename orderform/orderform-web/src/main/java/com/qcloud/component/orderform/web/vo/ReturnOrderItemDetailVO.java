...
public class ReturnOrderItemDetailVO {
	...
	public ReturnOrderItemDetailVO(){
	
	}

	public ReturnOrderItemDetailVO(long id,long orderId,long subOrderId,long orderItemId,long orderItemDetailId,int number,long returnId,long returnItemId,int state,int returnType){
		this.id = id;		
