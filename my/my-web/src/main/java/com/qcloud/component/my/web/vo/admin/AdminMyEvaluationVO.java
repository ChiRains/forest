...
public class AdminMyEvaluationVO {
	...
	public AdminMyEvaluationVO(){
	
	}

	public AdminMyEvaluationVO(long id,long evaluationId,long userId,long orderItemDetailId,Date orderTime){
		this.id = id;		
