...
<div class="row">
    <div class="col-xs-12">
        <!-- PAGE CONTENT BEGINS -->
        <form id="model-form" class="form-horizontal"  role="form" action="/admin/consignee/add.do">
            ...
            <div class="form-group">
                ...
                <div class="col-sm-9">
					<span class="col-sm-5 no-padding block input-icon input-icon-right mr10">
						<input type="text" class="width-100" maxlength="20" id="city" name="city" placeholder="市" value=""/>
						<i class="ace-icon fa"></i>
					</span>
                </div>
            </div>
            ...
            <div class="form-group">
                ...
                <div class="col-sm-9">
					<span class="col-sm-5 no-padding block input-icon input-icon-right mr10">
						<input type="text" class="width-100" maxlength="20" id="district" name="district" placeholder="区" value=""/>
						<i class="ace-icon fa"></i>
					</span>
                </div>
            </div>
            ...
            <div class="form-group">
                ...
                <div class="col-sm-9">
					<span class="col-sm-5 no-padding block input-icon input-icon-right mr10">
						<input type="text" class="width-100" maxlength="20" id="mobile" name="mobile" placeholder="电话" value=""/>
						<i class="ace-icon fa"></i>
					</span>
                </div>
            </div>
            ...
            <div class="form-group">
                ...
                <div class="col-sm-9">
					<span class="col-sm-5 no-padding block input-icon input-icon-right mr10">
						<input type="text" class="width-100" maxlength="20" id="email" name="email" placeholder="电子邮箱" value=""/>
						<i class="ace-icon fa"></i>
					</span>
                </div>
            </div>
