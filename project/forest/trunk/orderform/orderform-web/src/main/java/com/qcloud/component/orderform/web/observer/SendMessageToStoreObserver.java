...
@Component
public class SendMessageToStoreObserver extends AbstractNotifyAllStateOrderObserver {
    ...
    protected void doMerchantNotify(QMerchantOrder t, int state, String[] variable) {
        ...
        sellercenterClient.sendMsgToStore(t.getStoreId(), SellerMessageType.INSIDE_LETTER, "订单", "站内信是要从模板取的");
    }
