...
//
//@Component
//public class SignOrderFormTimer extends AbstractTimer {
//
//    @Autowired
...
//            logger.info("系统自动签收订单定时器 start" + DateUtil.date2String(new Date()));
//            orderStateService.sign();
//            logger.info("系统自动签收订单定时器 end" + DateUtil.date2String(new Date()));
//        }
//    }
//}
