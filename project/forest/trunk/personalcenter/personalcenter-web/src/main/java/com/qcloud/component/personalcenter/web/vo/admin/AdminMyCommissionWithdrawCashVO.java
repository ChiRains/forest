...
public class AdminMyCommissionWithdrawCashVO {
    ...
    public AdminMyCommissionWithdrawCashVO() {

    }

    public AdminMyCommissionWithdrawCashVO(long id, long wealthId, long wealthDetailId, long userId, double commissionCash, String cardholder, String bank, String card, Date time, Date completeTime, int state) {
