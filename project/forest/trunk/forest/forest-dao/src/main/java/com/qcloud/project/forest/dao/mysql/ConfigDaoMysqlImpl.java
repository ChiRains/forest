...
public class ConfigDaoMysqlImpl implements ConfigDao {
	...
	public Page<Config> page(int start, int count){
		...
		List<Config> list = sqlOperator.selectList(
				"com.qcloud.project.forest.dao.mysql.mapper.ConfigMapper.list4page",
				param);
		int total = sqlOperator.selectOne(
				"com.qcloud.project.forest.dao.mysql.mapper.ConfigMapper.count4page",
				param);
	...
	public Page<Config> page(ConfigQuery query, int start, int count){
		...
		List<Config> list = sqlOperator.selectList(
				"com.qcloud.project.forest.dao.mysql.mapper.ConfigMapper.list4query",
				param);
		int total = sqlOperator.selectOne(
				"com.qcloud.project.forest.dao.mysql.mapper.ConfigMapper.count4query",
				param);
		Page<Config> page = new Page<Config>();
		page.setCount(total);
		page.setData(list);
	...
	public List<Config> listAll(){	
		List<Config> list = sqlOperator.selectList(
				"com.qcloud.project.forest.dao.mysql.mapper.ConfigMapper.listAll");
		return list;
	}
}
