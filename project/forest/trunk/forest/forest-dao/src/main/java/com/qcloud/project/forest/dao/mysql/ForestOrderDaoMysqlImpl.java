...
public class ForestOrderDaoMysqlImpl implements ForestOrderDao {
	...
	public Page<ForestOrder> page(int start, int count){
		...
		List<ForestOrder> list = sqlOperator.selectList(
				"com.qcloud.project.forest.dao.mysql.mapper.ForestOrderMapper.list4page",
				param);
		int total = sqlOperator.selectOne(
				"com.qcloud.project.forest.dao.mysql.mapper.ForestOrderMapper.count4page",
				param);
	...
	public Page<ForestOrder> page(ForestOrderQuery query, int start, int count){
		...
		List<ForestOrder> list = sqlOperator.selectList(
				"com.qcloud.project.forest.dao.mysql.mapper.ForestOrderMapper.list4query",
				param);
		int total = sqlOperator.selectOne(
				"com.qcloud.project.forest.dao.mysql.mapper.ForestOrderMapper.count4query",
				param);
		Page<ForestOrder> page = new Page<ForestOrder>();
		page.setCount(total);
		page.setData(list);
	...
	public List<ForestOrder> listAll(){	
		List<ForestOrder> list = sqlOperator.selectList(
				"com.qcloud.project.forest.dao.mysql.mapper.ForestOrderMapper.listAll");
		return list;
	}
}
