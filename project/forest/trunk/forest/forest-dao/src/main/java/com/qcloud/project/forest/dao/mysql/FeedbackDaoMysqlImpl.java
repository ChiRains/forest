...
public class FeedbackDaoMysqlImpl implements FeedbackDao {
    ...
    public Page<Feedback> page(int start, int count) {
        ...
        List<Feedback> list = sqlOperator.selectList("com.qcloud.project.forest.dao.mysql.mapper.FeedbackMapper.list4page", param);
        int total = sqlOperator.selectOne("com.qcloud.project.forest.dao.mysql.mapper.FeedbackMapper.count4page", param);
    ...
    public Page<Feedback> page(FeedbackQuery query, int start, int count) {
        ...
        List<Feedback> list = sqlOperator.selectList("com.qcloud.project.forest.dao.mysql.mapper.FeedbackMapper.list4query", param);
        int total = sqlOperator.selectOne("com.qcloud.project.forest.dao.mysql.mapper.FeedbackMapper.count4query", param);
        Page<Feedback> page = new Page<Feedback>();
        page.setCount(total);
        page.setData(list);
        return page;
    ...
    public List<Feedback> listAll() {
        ...
        List<Feedback> list = sqlOperator.selectList("com.qcloud.project.forest.dao.mysql.mapper.FeedbackMapper.listAll");
        return list;
    }
}
