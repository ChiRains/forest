...
public class AdminPromotionalOffersController {
    ...
    // @RequestMapping
    // public ModelAndView toEditPromotionalOffer(Long id) {
    //
    // UnifiedMerchandise unifiedMerchandise = unifiedMerchandiseService.get(id);
    // ModelAndView modelAndView = new ModelAndView("/admin/forest-PromotionalOffers-add");
    // modelAndView.addObject("unifiedMerchandise", unifiedMerchandise);
    // return modelAndView;
    // }
    //
    // @RequestMapping
    // public AceAjaxView editPromotionalOffer(Long unifiedMerchandiseId, String image, Double discount, Integer integral, Integer stock, Long classifyId) {
    //
    // image = fileSDKClient.uidToUrl(image);
    // commoditycenterClient.regUnifiedMerchandise(unifiedMerchandiseId, 1, image, discount, integral, stock, classifyId);
    // AceAjaxView aceAjaxView = new AceAjaxView();
