...
<div class="row">
    <div class="col-xs-12">
        <!-- PAGE CONTENT BEGINS -->
        <form id="model-form" class="form-horizontal"  role="form" action="/admin/salesPromotion/addClassifyForMerchantCustom.do">
            ...
            <div class="clearfix form-actions">
                <div class="col-md-offset-3 col-md-9">
                    ...
                    &nbsp; &nbsp; &nbsp;
                    <button class="btn" type="button" onclick="window.location.href='#admin/salesPromotion/list'">
...
<script type="text/javascript">
    ...
    function change() {
		window.location.href = "#admin/salesPromotion/toAddClassifyForMerchantCustom?classifyId="+$("#classifyId").val();
	}
	</script>
