...
public class AdminScreeningsSlideVO {
	...
	public AdminScreeningsSlideVO(){
	
	}

	public AdminScreeningsSlideVO(long id,long screeningsId,String clickUrl,String image,int orderNum){
		this.id = id;		
