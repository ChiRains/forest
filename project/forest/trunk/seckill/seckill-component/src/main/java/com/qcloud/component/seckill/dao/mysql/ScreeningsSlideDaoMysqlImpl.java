...
public class ScreeningsSlideDaoMysqlImpl implements ScreeningsSlideDao {
    ...
    public Page<ScreeningsSlide> page(int start, int count) {
        ...
        List<ScreeningsSlide> list = sqlOperator.selectList("com.qcloud.component.seckill.dao.mysql.mapper.ScreeningsSlideMapper.list4page", param);
        int total = sqlOperator.selectOne("com.qcloud.component.seckill.dao.mysql.mapper.ScreeningsSlideMapper.count4page", param);
    ...
    public Page<ScreeningsSlide> page(ScreeningsSlideQuery query, int start, int count) {
        ...
        List<ScreeningsSlide> list = sqlOperator.selectList("com.qcloud.component.seckill.dao.mysql.mapper.ScreeningsSlideMapper.list4query", param);
        int total = sqlOperator.selectOne("com.qcloud.component.seckill.dao.mysql.mapper.ScreeningsSlideMapper.count4query", param);
        Page<ScreeningsSlide> page = new Page<ScreeningsSlide>();
        page.setCount(total);
        page.setData(list);
        return page;
    ...
    public List<ScreeningsSlide> listAll() {
        ...
        List<ScreeningsSlide> list = sqlOperator.selectList("com.qcloud.component.seckill.dao.mysql.mapper.ScreeningsSlideMapper.listAll");
        return list;
    }
    ...
    public List<ScreeningsSlide> listByScreenings(long screeningsId) {
        ...
        List<ScreeningsSlide> list = sqlOperator.selectList("com.qcloud.component.seckill.dao.mysql.mapper.ScreeningsSlideMapper.listByScreenings", screeningsId);
        return list;
    }
}
