...
//        List<CombinationMerchandise> list = sqlOperator.selectList("com.qcloud.component.goods.dao.mysql.mapper.CombinationMerchandiseMapper.list4page", param);
//        int total = sqlOperator.selectOne("com.qcloud.component.goods.dao.mysql.mapper.CombinationMerchandiseMapper.count4page", param);
...
//        param.put("start", start);
//        param.put("count", count);
//        List<CombinationMerchandise> list = sqlOperator.selectList("com.qcloud.component.goods.dao.mysql.mapper.CombinationMerchandiseMapper.list4query", param);
//        int total = sqlOperator.selectOne("com.qcloud.component.goods.dao.mysql.mapper.CombinationMerchandiseMapper.count4query", param);
//        Page<CombinationMerchandise> page = new Page<CombinationMerchandise>();
//        page.setCount(total);
//        page.setData(list);
//        return page;
...
//
//        List<CombinationMerchandise> list = sqlOperator.selectList("com.qcloud.component.goods.dao.mysql.mapper.CombinationMerchandiseMapper.listAll");
//        return list;
//    }
//
//    @Override
...
//
//        return sqlOperator.selectOne("com.qcloud.component.goods.dao.mysql.mapper.CombinationMerchandiseMapper.getByUnifiedMerchandise", unifiedMerchandiseId);
//    }
//
//    @Override
//    public List<CombinationMerchandise> list(Map where) {
//
//        return sqlOperator.selectList("com.qcloud.component.goods.dao.mysql.mapper.CombinationMerchandiseMapper.list", where);
//    }
//
//    @Override
...
//        where.put("start", 0);
//        where.put("count", 1);
//        return sqlOperator.selectOne("com.qcloud.component.goods.dao.mysql.mapper.CombinationMerchandiseMapper.list", where);
//    }
//
//    @Override
...
//        List<CombinationMerchandise> list = sqlOperator.selectList("com.qcloud.component.goods.dao.mysql.mapper.CombinationMerchandiseMapper.list", where);
//        int total = sqlOperator.selectOne("com.qcloud.component.goods.dao.mysql.mapper.CombinationMerchandiseMapper.count", where);
...
//        return sqlOperator.update("com.qcloud.component.goods.dao.mysql.mapper.CombinationMerchandiseMapper.update", map) > 0;
//    }
//}
