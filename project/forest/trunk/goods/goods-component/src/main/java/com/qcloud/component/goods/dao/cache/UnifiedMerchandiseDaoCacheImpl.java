...
public class UnifiedMerchandiseDaoCacheImpl implements UnifiedMerchandiseDao {
	...
	public UnifiedMerchandise get(Long id) {
		return CacheLoader.get(unifiedMerchandiseDaoRedisImpl, unifiedMerchandiseDaoMysqlImpl, id);
	}
	...
	public List<UnifiedMerchandise> list(List<Long> idList) {
		return CacheLoader.list(unifiedMerchandiseDaoRedisImpl, unifiedMerchandiseDaoMysqlImpl, idList);
	}

	@Override
	public Map<Long, UnifiedMerchandise> map(Set<Long> idSet){
		return CacheLoader.map(unifiedMerchandiseDaoRedisImpl, unifiedMerchandiseDaoMysqlImpl, idSet);
	}
