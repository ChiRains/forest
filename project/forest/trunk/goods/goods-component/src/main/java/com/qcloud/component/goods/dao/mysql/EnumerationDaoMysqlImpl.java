...
public class EnumerationDaoMysqlImpl implements EnumerationDao {
    ...
    public List<Enumeration> listByName(String name) {
        List<Enumeration> list = sqlOperator.selectList(
                "com.qcloud.component.goods.dao.mysql.mapper.EnumerationMapper.listByName",name);
        return list;
    }
    ...
    public boolean existByName(String name) {
        int total = sqlOperator.selectOne(
                "com.qcloud.component.goods.dao.mysql.mapper.EnumerationMapper.countByName",
                name);
        return total > 0;
    }
    ...
    public boolean deleteByName(String name) {
        return sqlOperator.delete("com.qcloud.component.goods.dao.mysql.mapper.EnumerationMapper.deleteByName", name) > 0;
    }

    @Override
    public List<String> listNames() {
        List<String> list = sqlOperator.selectList(
                "com.qcloud.component.goods.dao.mysql.mapper.EnumerationMapper.listNames");
        return list;
    }
}
