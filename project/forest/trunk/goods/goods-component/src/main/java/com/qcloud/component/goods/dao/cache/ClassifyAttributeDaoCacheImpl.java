...
public class ClassifyAttributeDaoCacheImpl implements ClassifyAttributeDao {
	...
	public ClassifyAttribute get(Long id) {
		return CacheLoader.get(classifyAttributeDaoRedisImpl, classifyAttributeDaoMysqlImpl, id);
	}
	...
	public List<ClassifyAttribute> list(List<Long> idList) {
		return CacheLoader.list(classifyAttributeDaoRedisImpl, classifyAttributeDaoMysqlImpl, idList);
	}

	@Override
	public Map<Long, ClassifyAttribute> map(Set<Long> idSet){
		return CacheLoader.map(classifyAttributeDaoRedisImpl, classifyAttributeDaoMysqlImpl, idSet);
	}
