...
public class MerchandiseBrowsingHistoryDaoMysqlImpl implements MerchandiseBrowsingHistoryDao {
	...
	public Page<MerchandiseBrowsingHistory> page(int start, int count){
		...
		List<MerchandiseBrowsingHistory> list = sqlOperator.selectList(
				"com.qcloud.component.goods.dao.mysql.mapper.MerchandiseBrowsingHistoryMapper.list4page",
				param);
		int total = sqlOperator.selectOne(
				"com.qcloud.component.goods.dao.mysql.mapper.MerchandiseBrowsingHistoryMapper.count4page",
				param);
	...
	public Page<MerchandiseBrowsingHistory> page(MerchandiseBrowsingHistoryQuery query, int start, int count){
		...
		List<MerchandiseBrowsingHistory> list = sqlOperator.selectList(
				"com.qcloud.component.goods.dao.mysql.mapper.MerchandiseBrowsingHistoryMapper.list4query",
				param);
		int total = sqlOperator.selectOne(
				"com.qcloud.component.goods.dao.mysql.mapper.MerchandiseBrowsingHistoryMapper.count4query",
				param);
		Page<MerchandiseBrowsingHistory> page = new Page<MerchandiseBrowsingHistory>();
		page.setCount(total);
		page.setData(list);
	...
	public List<MerchandiseBrowsingHistory> listAll(){	
		List<MerchandiseBrowsingHistory> list = sqlOperator.selectList(
				"com.qcloud.component.goods.dao.mysql.mapper.MerchandiseBrowsingHistoryMapper.listAll");
		return list;
	}
}
