...
public class AdminMerchandiseSpecificationsVO {
	...
	public AdminMerchandiseSpecificationsVO(long id,long merchandiseId,long attributeId0,String value0,long attributeId1,String value1,long attributeId2,String value2,int state){
		this.id = id;		
