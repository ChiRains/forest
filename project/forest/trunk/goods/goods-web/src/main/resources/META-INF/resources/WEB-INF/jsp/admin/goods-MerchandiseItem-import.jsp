...
<div class="row">
    <div class="col-xs-12">
        <!-- PAGE CONTENT BEGINS -->
        	  ...
        	  <form class="form-horizontal" role="form" id="validation-form"  action="/admin/merchandiseItem/merchandisePriceImport.do" method="post" enctype="multipart/form-data">
      ...
      jQuery(function($) {					
				...
				var deal_pic = function(){
					...
					file_input.on('file.error.ace', function(ev, info) {
						if(info.error_count['ext'] || info.error_count['mime']) alert('只支持上传excel文件');
