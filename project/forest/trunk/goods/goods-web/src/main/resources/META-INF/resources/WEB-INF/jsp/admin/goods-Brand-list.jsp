                           ...
                           <c:forEach items="${result}" var="item" varStatus="current"> 
                            <tr>            
                                ...
                                <div class="hidden-sm hidden-xs action-buttons">
                                    <button class="btn btn-success edit" api-path="#admin/brand/toEdit?type=1&id=${item.id}&queryStr=${queryStr}">修改</button>					                                 
                                    <button class="btn btn-warning check" api-path="#admin/brand/listMerchandise?classifyId=${item.id}&queryStr=${queryStr}">查看商品</button>
