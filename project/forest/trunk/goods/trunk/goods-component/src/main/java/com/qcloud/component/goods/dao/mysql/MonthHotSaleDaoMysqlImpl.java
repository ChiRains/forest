...
public class MonthHotSaleDaoMysqlImpl implements MonthHotSaleDao {
	...
	public Page<MonthHotSale> page(int start, int count){
		...
		List<MonthHotSale> list = sqlOperator.selectList(
				"com.qcloud.component.goods.dao.mysql.mapper.MonthHotSaleMapper.list4page",
				param);
		int total = sqlOperator.selectOne(
				"com.qcloud.component.goods.dao.mysql.mapper.MonthHotSaleMapper.count4page",
				param);
	...
	public Page<MonthHotSale> page(MonthHotSaleQuery query, int start, int count){
		...
		List<MonthHotSale> list = sqlOperator.selectList(
				"com.qcloud.component.goods.dao.mysql.mapper.MonthHotSaleMapper.list4query",
				param);
		int total = sqlOperator.selectOne(
				"com.qcloud.component.goods.dao.mysql.mapper.MonthHotSaleMapper.count4query",
				param);
		Page<MonthHotSale> page = new Page<MonthHotSale>();
		page.setCount(total);
		page.setData(list);
	...
	public List<MonthHotSale> listAll(){	
		List<MonthHotSale> list = sqlOperator.selectList(
				"com.qcloud.component.goods.dao.mysql.mapper.MonthHotSaleMapper.listAll");
		return list;
	}
}
