...
public class FullReducesDaoMysqlImpl implements FullReducesDao {
    ...
    public Page<FullReduces> page(int start, int count) {
        ...
        List<FullReduces> list = sqlOperator.selectList("com.qcloud.component.marketing.dao.mysql.mapper.FullReducesMapper.list4page", param);
        int total = sqlOperator.selectOne("com.qcloud.component.marketing.dao.mysql.mapper.FullReducesMapper.count4page", param);
    ...
    public Page<FullReduces> page(FullReducesQuery query, int start, int count) {
        ...
        List<FullReduces> list = sqlOperator.selectList("com.qcloud.component.marketing.dao.mysql.mapper.FullReducesMapper.list4query", param);
        int total = sqlOperator.selectOne("com.qcloud.component.marketing.dao.mysql.mapper.FullReducesMapper.count4query", param);
        Page<FullReduces> page = new Page<FullReduces>();
        page.setCount(total);
        page.setData(list);
        return page;
