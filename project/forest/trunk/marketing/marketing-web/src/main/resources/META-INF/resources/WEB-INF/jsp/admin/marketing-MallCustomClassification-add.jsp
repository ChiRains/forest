...
<div class="row">
    <div class="col-xs-12">
        <!-- PAGE CONTENT BEGINS -->
        <form id="model-form" class="form-horizontal"  role="form" action="/admin/merchandiseCustomClassification/addClassifyForMallCustom.do">
            ...
            <div class="clearfix form-actions">
                <div class="col-md-offset-3 col-md-9">
                    ...
                    &nbsp; &nbsp; &nbsp;
                    <button class="btn" type="button" onclick="window.location.href='#admin/merchandiseCustomClassification/mallList'">
...
<script type="text/javascript">
    ...
    function change() {
		window.location.href = "#admin/merchandiseCustomClassification/toAddClassifyForMallCustom?classifyId="+$("#classifyId").val();
	}
</script>
