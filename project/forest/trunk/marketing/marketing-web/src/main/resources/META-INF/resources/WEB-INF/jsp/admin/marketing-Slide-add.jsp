    ...
    <div class="col-xs-12">
        ...
        <form id="model-form" class="form-horizontal"  role="form" action="/admin/slide/add.do">
            ...
            <div class="form-group">
                ...
                <div class="col-sm-9">
					<span class="col-sm-5 no-padding block input-icon input-icon-right mr10">
						<input type="text" class="width-100" maxlength="50" id="desc" name="desc" placeholder="描述" value=""/>
            ...
            <div class="form-group">
                ...
                <div class="col-sm-9">
					<span class="col-sm-5 no-padding block input-icon input-icon-right mr10">
						<input type="text" class="width-100" maxlength="200" id="clickUrl" name="clickUrl" placeholder="点击地址" value=""/>
						<i class="ace-icon fa"></i>
					</span>
                </div>
            </div>                       	
