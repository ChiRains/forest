...
<div class="row">
    <div class="col-xs-12">
        <!-- PAGE CONTENT BEGINS -->
        <form id="model-form" class="form-horizontal"  role="form" action="/admin/merchandiseCustomClassification/addCustomMall.do">
            ...
            <div class="form-group">
                ...
                <div class="col-sm-9">
					<span class="col-sm-5 no-padding block input-icon input-icon-right mr10">
						<select class="width-80" id="classifyId" name="classifyId"  >
		                 	<c:forEach items="${classify}" var="classify" varStatus="current">
                    ...
                    <table class="table table-striped table-bordered table-hover kv-table">
                        ...
                        <c:forEach items="${voList}" var="item" varStatus="current">
                            <tr class="template kv-table-row">
                                <td><input type="text"name="unifiedMerchandiseIds[${current.index}]" value="${item.unifiedMerchandiseId}" readonly class="config-key"></td>
...
<script type="text/javascript">
        ...
        jQuery(function ($) {
            ...
            $(".add-row-trigger").on("click", function () {
                BootstrapDialog.show({
                    title: "商品列表",
                    message: $('<div></div>').load('/admin/merchandiseItem/produce4CustomMall.do?merchantId=${merchantId}&pageNum=1'),
    ...
    //function change() {
	//	window.location.href = "/admin/index.do#admin/merchandiseCustomClassification/toAddClassifyForMallCustom?classifyId="+$("#classifyId").val();
	//}
</script>
