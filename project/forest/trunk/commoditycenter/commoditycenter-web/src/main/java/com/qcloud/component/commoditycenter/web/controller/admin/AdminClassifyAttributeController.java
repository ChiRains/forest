...
public class AdminClassifyAttributeController {
    ...
    public ModelAndView list() {
        ...
        ModelAndView model = new ModelAndView("/admin/commoditycenter-ClassifyAttribute-list");
    ...
    public ModelAndView toSetAttributes(Long classifyId) {
        ...
        ModelAndView model = new ModelAndView("/admin/commoditycenter-ClassifyAttribute-setAttributes");
    ...
    public ModelAndView toAddClassifyAttributes(Long classifyId) {
        ...
        Classify classify = publicdataClient.getClassify(classifyId);
        AssertUtil.assertNotNull(classify, "指定分类不存在." + classifyId);
        ModelAndView view = new ModelAndView("/admin/commoditycenter-ClassifyAttribute-addClassifyAttributes");
    ...
    public ModelAndView toEditClassifyAttributes(Long id) {
        ...
        ModelAndView view = new ModelAndView("/admin/commoditycenter-ClassifyAttribute-editClassifyAttributes");
        view.addObject("classify", classify);
    ...
    public ModelAndView toAdd() {
        ...
        ModelAndView model = new ModelAndView("/admin/commoditycenter-ClassifyAttribute-add");
        return model;
    }
    ...
    public ModelAndView toEdit(Long id) {
        ...
        ModelAndView model = new ModelAndView("/admin/commoditycenter-ClassifyAttribute-edit");
    ...
    public ModelAndView toAddClassifyAttr(Long classifyId) {
        ...
        ModelAndView model = new ModelAndView("/admin/commoditycenter-ClassifyAttribute-addAttr");
    ...
    public ModelAndView toEditClassifyAttr(Long id) {
        ...
        ModelAndView model = new ModelAndView("/admin/commoditycenter-ClassifyAttribute-editAttr");
