...
public class AdminMerchandiseSpecificationsRelationController {
	...
	public ModelAndView list(Integer pageNum, MerchandiseSpecificationsRelationQuery query) {
		...
		AcePagingView pagingView = new AcePagingView("/admin/commoditycenter-MerchandiseSpecificationsRelation-list", DIR
	...
	public ModelAndView toAdd() {
		ModelAndView model = new ModelAndView("/admin/commoditycenter-MerchandiseSpecificationsRelation-add");
		return model;
	}
	...
	public ModelAndView toEdit(Long id) {
		...
		ModelAndView model = new ModelAndView("/admin/commoditycenter-MerchandiseSpecificationsRelation-edit");
