...
import com.qcloud.component.commoditycenter.web.vo.admin.AdminMerchandiseImageVO;
...
public class AdminMerchandiseImageController {
	...
	public ModelAndView list(Integer pageNum, MerchandiseImageQuery query) {
		...
		AcePagingView pagingView = new AcePagingView("/admin/commoditycenter-MerchandiseImage-list", DIR
	...
	public ModelAndView toAdd() {
		ModelAndView model = new ModelAndView("/admin/commoditycenter-MerchandiseImage-add");
		return model;
	}
	...
	public ModelAndView toEdit(Long id) {
		...
		ModelAndView model = new ModelAndView("/admin/commoditycenter-MerchandiseImage-edit");
