...
public class MonthHotSale {
	...
	public MonthHotSale(long id,long mallClassifyId,String mallBsid,long unifiedMerchandiseId,int number,int year,int month,long merchantClassifyId,String merchantBsid){
		this.id = id;		
