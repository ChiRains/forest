...
public class AdminSexpressDistrictVO {
	...
	public AdminSexpressDistrictVO(){
	
	}

	public AdminSexpressDistrictVO(long id,long expressId,double firstPrice,double continuedPrice,String province,String city,String district){
		this.id = id;		
