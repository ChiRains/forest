...
public class PayRecordDaoMysqlImpl implements PayRecordDao {
	...
	public Page<PayRecord> page(int start, int count){
		...
		List<PayRecord> list = sqlOperator.selectList(
				"com.qcloud.component.pay.dao.mysql.mapper.PayRecordMapper.list4page",
				param);
		int total = sqlOperator.selectOne(
				"com.qcloud.component.pay.dao.mysql.mapper.PayRecordMapper.count4page",
				param);
	...
	public Page<PayRecord> page(PayRecordQuery query, int start, int count){
		...
		List<PayRecord> list = sqlOperator.selectList(
				"com.qcloud.component.pay.dao.mysql.mapper.PayRecordMapper.list4query",
				param);
		int total = sqlOperator.selectOne(
				"com.qcloud.component.pay.dao.mysql.mapper.PayRecordMapper.count4query",
				param);
		Page<PayRecord> page = new Page<PayRecord>();
		page.setCount(total);
		page.setData(list);
	...
	public List<PayRecord> listAll(){	
		List<PayRecord> list = sqlOperator.selectList(
				"com.qcloud.component.pay.dao.mysql.mapper.PayRecordMapper.listAll");
		return list;
	}
}
