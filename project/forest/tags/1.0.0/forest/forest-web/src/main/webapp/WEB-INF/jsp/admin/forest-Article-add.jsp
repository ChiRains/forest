    ...
    <div class="col-xs-12">
        ...
        <form id="model-form" class="form-horizontal"  role="form" action="/admin/article/add.do">
            ...
            <div class="form-group">
                ...
                <div class="col-sm-9">
					<span class="col-sm-5 no-padding block input-icon input-icon-right mr10">
						<input type="text" class="width-100" maxlength="20" id="title" name="title" placeholder="标题" value=""/>
                ...
                <div class="col-sm-9">
					<span class="col-sm-5 no-padding block input-icon input-icon-right mr10">
						<select class="form-control" id="classifyId" name="classifyId" >
										<option value="0" selected="selected">请选择资讯类别</option>
            ...
            <div class="form-group">
                ...
                <div class="col-sm-9">
					<span class="col-sm-5 no-padding block input-icon input-icon-right mr10">
	 					<textarea   class="width-100" maxlength="50" row ="2" id="brief" name="brief"  placeholder="文章介绍"></textarea>					
						<i class="ace-icon fa"></i>
					</span>
                </div>
            </div>
            ...
            <div class="form-group">
                ...
                <div class="col-sm-9">
					...
					<textarea style="height:600px!important;width:600px!important;" 
						class="col-xs-10 no-float" id="content" name="content"></textarea>					
					<i class="ace-icon fa"></i>
					</span>
                </div>
            </div>
