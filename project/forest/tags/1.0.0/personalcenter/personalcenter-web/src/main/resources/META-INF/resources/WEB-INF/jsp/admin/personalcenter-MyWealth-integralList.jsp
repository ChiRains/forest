                ...
                <div class="row">
                    ...
                    <div class="col-xs-6">
                    	<div class="dataTables_length" >
                            <a title="注册送积分" class="btn btn-sm btn-info"
                               href="#admin/pointConfig/getRegistrationPoint">
                    ...
                    <form action="#admin/myWealth/integralList" id="query-form" onsubmit="listFormSearch(this); return false">
                    <div class="col-xs-6">
                        ...
                        <tr>            
	                            ...
	                            <div class="hidden-sm hidden-xs action-buttons">
	                                <a title="修改基本信息" class="green" 
	                                   href="#admin/myWealth/toEditIntegral?id=${item.id}">
