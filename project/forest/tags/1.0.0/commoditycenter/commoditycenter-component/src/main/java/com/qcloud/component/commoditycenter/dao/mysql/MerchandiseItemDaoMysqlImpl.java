...
public class MerchandiseItemDaoMysqlImpl implements MerchandiseItemDao {
    ...
    public boolean add(MerchandiseItem merchandiseItem) {
        ...
        return sqlOperator.insert("com.qcloud.component.commoditycenter.dao.mysql.mapper.MerchandiseItemMapper.insert", merchandiseItem) == 1;
    }

    @Override
    public MerchandiseItem get(Long id) {

        return sqlOperator.selectOne("com.qcloud.component.commoditycenter.dao.mysql.mapper.MerchandiseItemMapper.get", id);
    }

    @Override
    public boolean delete(Long id) {

        return sqlOperator.delete("com.qcloud.component.commoditycenter.dao.mysql.mapper.MerchandiseItemMapper.delete", id) > 0;
    }
    ...
    public Page<MerchandiseItem> page(int start, int count) {
        ...
        List<MerchandiseItem> list = sqlOperator.selectList("com.qcloud.component.commoditycenter.dao.mysql.mapper.MerchandiseItemMapper.list4page", param);
        int total = sqlOperator.selectOne("com.qcloud.component.commoditycenter.dao.mysql.mapper.MerchandiseItemMapper.count4page", param);
    ...
    public Page<MerchandiseItem> page(MerchandiseItemQuery query, int start, int count) {
        ...
        List<MerchandiseItem> list = sqlOperator.selectList("com.qcloud.component.commoditycenter.dao.mysql.mapper.MerchandiseItemMapper.list4query", param);
        int total = sqlOperator.selectOne("com.qcloud.component.commoditycenter.dao.mysql.mapper.MerchandiseItemMapper.count4query", param);
        Page<MerchandiseItem> page = new Page<MerchandiseItem>();
        page.setCount(total);
        page.setData(list);
        return page;
    ...
    public List<MerchandiseItem> listAll() {
        ...
        List<MerchandiseItem> list = sqlOperator.selectList("com.qcloud.component.commoditycenter.dao.mysql.mapper.MerchandiseItemMapper.listAll");
        return list;
    }
    ...
    public MerchandiseItem getByUnifiedMerchandise(Long unifiedMerchandiseId) {
        ...
        return sqlOperator.selectOne("com.qcloud.component.commoditycenter.dao.mysql.mapper.MerchandiseItemMapper.getByUnifiedMerchandise", unifiedMerchandiseId);
    }

    @Override
    public List<MerchandiseItem> list(Map where) {

        return sqlOperator.selectList("com.qcloud.component.commoditycenter.dao.mysql.mapper.MerchandiseItemMapper.list", where);
    }
    ...
    public MerchandiseItem get(Map where) {
        ...
        where.put("start", 0);
        where.put("count", 1);
        return sqlOperator.selectOne("com.qcloud.component.commoditycenter.dao.mysql.mapper.MerchandiseItemMapper.list", where);
    }
    ...
    public Page<MerchandiseItem> page(Map where, int start, int size) {
        ...
        List<MerchandiseItem> list = sqlOperator.selectList("com.qcloud.component.commoditycenter.dao.mysql.mapper.MerchandiseItemMapper.list", where);
        int total = sqlOperator.selectOne("com.qcloud.component.commoditycenter.dao.mysql.mapper.MerchandiseItemMapper.count", where);
    ...
    public List<MerchandiseItem> listByMerchandise(Long merchandiseId) {
        ...
        List<MerchandiseItem> list = sqlOperator.selectList("com.qcloud.component.commoditycenter.dao.mysql.mapper.MerchandiseItemMapper.listByMerchandise", merchandiseId);
        return list;
    }
    ...
    public Page<MerchandiseItem> page4Price(String name, Long merchantId, Long merchantClassifyId, int start, int size, OrderType orderType, QueryItemType queryItemType) {
        ...
        List<MerchandiseItem> list = sqlOperator.selectList("com.qcloud.component.commoditycenter.dao.mysql.mapper.MerchandiseItemMapper.list4Front", param);
        int total = sqlOperator.selectOne("com.qcloud.component.commoditycenter.dao.mysql.mapper.MerchandiseItemMapper.count4Front", param);
        Page<MerchandiseItem> page = new Page<MerchandiseItem>();
        page.setCount(total);
        page.setData(list);
        return page;
    ...
    public MerchandiseItem getBySpecifications(Long merchandiseId, Long merchandiseSpecificationsId) {
        ...
        return sqlOperator.selectOne("com.qcloud.component.commoditycenter.dao.mysql.mapper.MerchandiseItemMapper.getBySpecifications", param);
    }
    ...
    public boolean update(MerchandiseItem merchandiseItem, Date lastUpdateTime) {
        ...
        return sqlOperator.update("com.qcloud.component.commoditycenter.dao.mysql.mapper.MerchandiseItemMapper.update", map) > 0;
    }
    ...
    public Page<MerchandiseItem> list4Select4Admin(MerchandiseItemQuery query, int start, int count) {
        ...
        List<MerchandiseItem> list = sqlOperator.selectList("com.qcloud.component.commoditycenter.dao.mysql.mapper.MerchandiseItemMapper.list4Select4Admin", param);
        int total = sqlOperator.selectOne("com.qcloud.component.commoditycenter.dao.mysql.mapper.MerchandiseItemMapper.count4Select4Admin", param);
        Page<MerchandiseItem> page = new Page<MerchandiseItem>();
        page.setCount(total);
        page.setData(list);
        return page;
    ...
    public List<MerchandiseItem> merchandiseListByMerchantId(long merchantId) {
        ...
        Map<String, Object> param = new HashMap<String, Object>();
        param.put("merchantId", merchantId);
        return sqlOperator.selectList("com.qcloud.component.commoditycenter.dao.mysql.mapper.MerchandiseItemMapper.merchandiseListByMerchantId", param);
    }
}
