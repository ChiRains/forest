...
public class MerchandiseAttributeDaoCacheImpl implements MerchandiseAttributeDao {
    ...
    public MerchandiseAttribute get(Long id) {
        return merchandiseAttributeDaoMysqlImpl.get(id);
    ...
    public List<MerchandiseAttribute> list(List<Long> idList) {
        return CacheLoader.list(merchandiseAttributeDaoMysqlImpl, idList);
    ...
    public Map<Long, MerchandiseAttribute> map(Set<Long> idSet) {
        return CacheLoader.map(merchandiseAttributeDaoMysqlImpl, idSet);
    ...
    public List<MerchandiseAttribute> listByMerchandise(long merchandiseId) {
        return merchandiseAttributeDaoMysqlImpl.listByMerchandise(merchandiseId);
    }
}
