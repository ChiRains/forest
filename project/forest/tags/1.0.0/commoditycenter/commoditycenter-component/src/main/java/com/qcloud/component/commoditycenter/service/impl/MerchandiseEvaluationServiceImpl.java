...
public class MerchandiseEvaluationServiceImpl implements MerchandiseEvaluationService {
    ...
    private static final String      ID_KEY = "commoditycenter_merchandise_evaluation";
    ...
    public boolean evaluate(long toEvaluationId, long userId, String content, int star) {
        ...
        add(merchandiseEvaluation);
        sellercenterClient.addMerchantEvaluation(merchandiseEvaluation.getId(), myToEvaluation.getMerchantId(), merchandiseEvaluation.getMerchandiseId());
