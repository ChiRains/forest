...
public class AdminMerchandiseSpecificationsController {
	...
	public ModelAndView list(Integer pageNum, MerchandiseSpecificationsQuery query) {
		...
		AcePagingView pagingView = new AcePagingView("/admin/commoditycenter-MerchandiseSpecifications-list", DIR
	...
	public ModelAndView toAdd() {
		ModelAndView model = new ModelAndView("/admin/commoditycenter-MerchandiseSpecifications-add");
		return model;
	}
	...
	public ModelAndView toEdit(Long id) {
		...
		ModelAndView model = new ModelAndView("/admin/commoditycenter-MerchandiseSpecifications-edit");
