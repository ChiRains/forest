                ...
                <div class="row">
                    ...
                    <div class="col-xs-6">
	                    <div class="text-right">
	                        <label>
	                            <form action="#admin/returnOrder/list" onsubmit="listFormSearch(this); return false">
	                                <div class="dataTables_length">   
                            ...
                            <tr>            
                                ...
                                <div class="hidden-sm hidden-xs action-buttons">
                                	<a title="查看明细" class="green" 
                                       href="#admin/returnOrder/getDetails?id=${item.id}">
                                        <i class="ace-icon fa fa-eye bigger-130"></i>
                                    </a>
                                     <c:if test="${state==350}">
                                     	确认签收
	                                    <a title="卖家确认签收" class="green confirmOrder-item" href="javascript:;"
	                                    api-path="/afterSaleState/signReturn.do?returnId=${item.id}">
