...
public class OrderItemDetail {
	...
	public OrderItemDetail(long id,long orderId,long subOrderId,long orderItemId,long merchantId,long unifiedMerchandiseId,long merchandiseItemId,int number,String name,int state,String specifications,String image,String code,double weight){
		this.id = id;		
