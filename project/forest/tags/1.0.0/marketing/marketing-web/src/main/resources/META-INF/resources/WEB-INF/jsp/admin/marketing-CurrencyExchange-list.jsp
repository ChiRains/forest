            ...
            <div class="dataTables_wrapper form-inline no-footer">
                <div class="row">
                    <div class="col-xs-6">
                        <div class="dataTables_length">
                            <a title="新增" class="btn btn-sm btn-info"
                               href="#admin/currencyExchange/toAdd">
                    ...
                    <div class="col-xs-6" style="text-align: right;">
                        <label>
                            <form id="query-form" action="#admin/currencyExchange/exchangeList" onsubmit="listFormSearch(this); return false">
                            	<div class="dataTables_length">
                 ...
                 <form id="model-form" class="form-horizontal"  role="form" action="/admin/currencyExchange/multipleSort.do">
                            ...
                            <tr>            
                                ...
                                <div class="hidden-sm hidden-xs action-buttons">
                                    <a title="删除" class="green" 
                                       api-path="/admin/currencyExchange/delete.do?id=${item.id}">
