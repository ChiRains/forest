...
<div class="row">
    <div class="col-xs-12">
        <!-- PAGE CONTENT BEGINS -->
        <form id="model-form" class="form-horizontal"  role="form" action="/admin/couponItems/edit4Merchant.do">
            <!-- #section:elements.form -->
            <!--        <div class="space-4"></div>
			<c:if test="${couponItems.sendNum==0}">
            ...
            <div class="form-group">
                ...
                <div class="col-sm-9">
					<span class="col-sm-5 no-padding block input-icon input-icon-right mr10">
					<input type="hidden" class="width-100" readonly maxlength="20" id="id" name="id" placeholder="" value="${couponItems.id}"/>
					<input type="hidden" class="width-100" readonly maxlength="20" id="couponID" name="couponID" placeholder="优惠券ID" value="${couponItems.couponID}"/>
