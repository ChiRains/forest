                ...
                <div class="row">
                    <div class="col-xs-6">
                        <div class="dataTables_length">
                            <a title="新增" class="btn btn-sm btn-info"
                               href="#admin/merchandiseCustomClassification/toAddClassifyForMerchantCustom">
                    ...
                    <div class="col-xs-6">
	                    <div class="text-right">
	                        <label>
	                            <form action="#admin/merchandiseCustomClassification/list" onsubmit="listFormSearch(this); return false">
	                               <div class="dataTables_length">
