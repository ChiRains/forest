...
public class AdminSexpressVO {
	...
	public AdminSexpressVO(){
	
	}

	public AdminSexpressVO(long id,long merchandId,String name,String code,String desc,String logo,long sort,double firstWeight,double firstPrice,double continuedWeight,double continuedPrice,long enable,int type){
		this.id = id;		
