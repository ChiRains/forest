...
public class AdminStoreDeliveryTimeVO {
	...
	public AdminStoreDeliveryTimeVO(){
	
	}

	public AdminStoreDeliveryTimeVO(long id,long storeId,String pickupStartTime,String pickupEndTime,String pickupDesc,String deliveryStartTime,String deliveryEndTime,int deliveryFrequency,int deliveryDuration){
		this.id = id;		
