...
<div class="row">
    <div class="col-xs-12">
        <!-- PAGE CONTENT BEGINS -->
        <form id="model-form" class="form-horizontal" role="form" action="/admin/store/edit.do">
                ...
                <div class="col-sm-9">
					<span class="col-sm-5 no-padding block input-icon input-icon-right mr10">						
						<select class="form-control" id="parentId" name="parentId">
                            <option value="-1" selected>请选择一个门店</option>
                ...
                <div class="col-sm-9">
					<span class="col-sm-5 no-padding block input-icon input-icon-right mr10">
						<%--<input type="text" class="width-100" maxlength="20" id="icon" name="icon" placeholder="图标"--%>
                               <%--value="${pages.icon}"/>--%>
						<%--<i class="ace-icon fa"></i>--%>
                    <input type="hidden" id="logo" name="logo" value="${store.logoUid}"/>
                    ...
                    <ul sid="logo" id="pic-pic-view" class="ace-thumbnails clearfix">
                        <c:if test="${store.logoUid !=null && store.logoUid != \"\"}">
                            <li pic-id="${store.logoUid}">
                                <a style="line-height: 150px;text-align: center;width:150px;height: 150px;"
                                   href="/file/get.do?uid=${store.logoUid}" data-rel="colorbox" class="cboxElement">
                                    <img style="max-height: 150px;max-width: 150px;" alt="" src="/file/get.do?uid=${store.logoUid}">
                                </a>
            ...
            <div class="form-group">
                ...
                <div class="col-sm-9">
					<span class="col-sm-5 no-padding block input-icon input-icon-right mr10">
						<input type="text" class="width-100"  maxlength="11" id="mobile" name="mobile" placeholder="接收短信的手机号" value="${store.mobile}"/>
						<i class="ace-icon fa"></i>
					</span>
                </div>
            </div>
