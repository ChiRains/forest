                        ...
                        <c:forEach items="${qclassify}" var="levelOne" varStatus="current">
                            <li class="dd-item" data-id="${levelOne.id}">
                                <div class="dd-handle">
                                	...
                                	<span class=""><img src="${levelOne.image}" width="25" height="25" /> &nbsp;${levelOne.name}</span>
                                    <div class="pull-right action-buttons">
                                    	...
                                    	&nbsp;&nbsp;<a class="red del-item-new" api-path="/admin/classifyMerchant/deleteMerchantClassify.do?id=${levelOne.id}" title="删除" ><i class="ace-icon fa fa-trash-o bigger-130"></i></a>
                                 ...
                                 <c:forEach items="${levelOne.childrenList}" var="levelTwo" varStatus="current">
				                    <li class="dd-item item-blue2" data-id="${levelTwo.id}">
				                        <div class="dd-handle">
				                        	 <span class=""><img src="${levelTwo.image}" width="25" height="25"/> &nbsp;${levelOne.name}--${levelTwo.name}</span>
				                            <div class="pull-right action-buttons">
		                                        ...
		                                        &nbsp;&nbsp;<img title="向下" api-path="/admin/classify4Type/down.do?id=${levelTwo.id}" class="sortpng" src="/qcloud-admin/assets/img/down.png" width="14"  height="15"/> 
		                                     	&nbsp;&nbsp;<a class="red del-item-new" api-path="/admin/classifyMerchant/deleteMerchantClassify.do?id=${levelTwo.id}" title="删除" ><i class="ace-icon fa fa-trash-o bigger-130"></i></a>
		                                     	<input value="${levelTwo.id}" <c:if test="${levelOne.enable!=1}"> disabled="true" </c:if> <c:if test="${levelTwo.enable==1}"> checked </c:if>  type="checkbox" data-id="${levelTwo.id}" class="ace ace-switch ace-switch-6 ajax_switch" >
                                				<span class="lbl middle"></span>
				                         ...
				                         <ol class="dd-list">
					                         <c:forEach items="${levelTwo.childrenList}" var="levelThree" varStatus="current">
							                    <li class="dd-item item-orange" data-id="${levelThree.id}">
							                        <div class="dd-handle">
							                        	 <span class=""><img src="${levelThree.image}" width="25" height="25"/> &nbsp;${levelOne.name}--${levelTwo.name}--${levelThree.name}</span>
							                            <div class="pull-right action-buttons">
							                            	...
							                            	&nbsp;&nbsp;<a class="red del-item-new" api-path="/admin/classifyMerchant/deleteMerchantClassify.do?id=${levelThree.id}" title="删除" ><i class="ace-icon fa fa-trash-o bigger-130"></i></a>
							                            	<input value="${levelThree.id}"
							                            	<c:if test="${levelOne.enable!=1 || levelTwo.enable!=1}"> disabled="true" </c:if>
							                            	 <c:if test="${levelThree.enable==1}"> checked </c:if>  type="checkbox" data-id="${levelThree.id}" class="ace ace-switch ace-switch-6 ajax_switch" >
                                							<span class="lbl middle"></span>
