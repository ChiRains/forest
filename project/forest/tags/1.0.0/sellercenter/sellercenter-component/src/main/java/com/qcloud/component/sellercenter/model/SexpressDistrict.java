...
public class SexpressDistrict {
	...
	public SexpressDistrict(){
	
	}

	public SexpressDistrict(long id,long expressId,double firstPrice,double continuedPrice,String province,String city,String district){
		this.id = id;		
