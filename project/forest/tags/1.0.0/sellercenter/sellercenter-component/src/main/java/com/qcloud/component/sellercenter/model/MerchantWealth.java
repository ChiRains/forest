...
public class MerchantWealth {
	...
	public MerchantWealth(){
	
	}

	public MerchantWealth(long id,long merchantId,long integral,double commission,double consumptionCurrency,long integralSummation,double commissionSummation,double consumptionCurrencySummation,Date time,long version){
		this.id = id;		
