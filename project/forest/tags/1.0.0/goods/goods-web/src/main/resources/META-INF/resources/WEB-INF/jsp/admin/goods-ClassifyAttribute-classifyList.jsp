        ...
        <div class="row">
            <div class="col-sm-12">
                <div class="dd" id="nestable">
                    <ol class="dd-list">
                        <c:forEach items="${qlist}" var="levelOne" varStatus="current">
                            <li class="dd-item" data-id="${levelOne.id}">
                                <div class="dd-handle">
                                    ...
                                    <div class="pull-right action-buttons">
                                    	...
                                    	&nbsp;&nbsp;<a class="red del-item-new" api-path="/admin/classifyAttribute/deleteMallClassify.do?id=${levelOne.id}" title="删除" ><i class="ace-icon fa fa-trash-o bigger-130"></i></a>
				                        ...
				                        <div class="dd-handle">
				                            ...
				                            <div class="pull-right action-buttons">
		                                        ...
		                                        &nbsp;&nbsp;<img title="向下" api-path="/admin/classify4Type/down.do?id=${levelTwo.id}" class="sortpng" src="/qcloud-admin/assets/img/down.png" width="14"  height="15"/> 
		                                     	&nbsp;&nbsp;<a class="red del-item-new" api-path="/admin/classifyAttribute/deleteMallClassify.do?id=${levelTwo.id}" title="删除" ><i class="ace-icon fa fa-trash-o bigger-130"></i></a>
							                    ...
							                    <li class="dd-item item-orange" data-id="${levelThree.id}">
							                        <div class="dd-handle">
							                            ...
							                            <div class="pull-right action-buttons">
							                            	...
							                            	&nbsp;&nbsp;<a class="red del-item-new" api-path="/admin/classifyAttribute/deleteMallClassify.do?id=${levelThree.id}" title="删除" ><i class="ace-icon fa fa-trash-o bigger-130"></i></a>
