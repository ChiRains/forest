...
public class CombinationMerchandiseItemDaoMysqlImpl implements CombinationMerchandiseItemDao {
    ...
    public Page<CombinationMerchandiseItem> page(int start, int count) {
        ...
        List<CombinationMerchandiseItem> list = sqlOperator.selectList("com.qcloud.component.goods.dao.mysql.mapper.CombinationMerchandiseItemMapper.list4page", param);
        int total = sqlOperator.selectOne("com.qcloud.component.goods.dao.mysql.mapper.CombinationMerchandiseItemMapper.count4page", param);
    ...
    public Page<CombinationMerchandiseItem> page(CombinationMerchandiseItemQuery query, int start, int count) {
        ...
        param.put("start", start);
        param.put("count", count);
        List<CombinationMerchandiseItem> list = sqlOperator.selectList("com.qcloud.component.goods.dao.mysql.mapper.CombinationMerchandiseItemMapper.list4query", param);
        int total = sqlOperator.selectOne("com.qcloud.component.goods.dao.mysql.mapper.CombinationMerchandiseItemMapper.count4query", param);
        Page<CombinationMerchandiseItem> page = new Page<CombinationMerchandiseItem>();
        page.setCount(total);
        page.setData(list);
        return page;
    ...
    public List<CombinationMerchandiseItem> listAll() {
        ...
        List<CombinationMerchandiseItem> list = sqlOperator.selectList("com.qcloud.component.goods.dao.mysql.mapper.CombinationMerchandiseItemMapper.listAll");
        return list;
    }
    ...
    public List<CombinationMerchandiseItem> listByCombinationMerchandise(long combinationMerchandiseId) {
        ...
        List<CombinationMerchandiseItem> list = sqlOperator.selectList("com.qcloud.component.goods.dao.mysql.mapper.CombinationMerchandiseItemMapper.listByCombinationMerchandise", combinationMerchandiseId);
        return list;
    }
    ...
    public List<CombinationMerchandiseItem> list(Map where) {
        ...
        return sqlOperator.selectList("com.qcloud.component.goods.dao.mysql.mapper.CombinationMerchandiseItemMapper.list", where);
    }

    @Override
    public boolean delete(Map where) {

        return sqlOperator.delete("com.qcloud.component.goods.dao.mysql.mapper.CombinationMerchandiseItemMapper.del", where) > 0;
    }
    ...
    public int countByMerchandiseItem(Long merchandiseItemId) {
        return sqlOperator.selectOne("com.qcloud.component.goods.dao.mysql.mapper.CombinationMerchandiseItemMapper.countByMerchandiseItem", merchandiseItemId);
    }
}
