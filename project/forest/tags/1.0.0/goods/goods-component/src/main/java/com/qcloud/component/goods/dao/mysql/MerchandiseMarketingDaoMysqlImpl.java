...
public class MerchandiseMarketingDaoMysqlImpl implements MerchandiseMarketingDao {
    ...
    public Page<MerchandiseMarketing> page(int start, int count) {
        ...
        List<MerchandiseMarketing> list = sqlOperator.selectList("com.qcloud.component.goods.dao.mysql.mapper.MerchandiseMarketingMapper.list4page", param);
        int total = sqlOperator.selectOne("com.qcloud.component.goods.dao.mysql.mapper.MerchandiseMarketingMapper.count4page", param);
    ...
    public Page<MerchandiseMarketing> page(MerchandiseMarketingQuery query, int start, int count) {
        ...
        List<MerchandiseMarketing> list = sqlOperator.selectList("com.qcloud.component.goods.dao.mysql.mapper.MerchandiseMarketingMapper.list4query", param);
        int total = sqlOperator.selectOne("com.qcloud.component.goods.dao.mysql.mapper.MerchandiseMarketingMapper.count4query", param);
        Page<MerchandiseMarketing> page = new Page<MerchandiseMarketing>();
        page.setCount(total);
        page.setData(list);
        return page;
    ...
    public List<MerchandiseMarketing> listAll() {
        ...
        List<MerchandiseMarketing> list = sqlOperator.selectList("com.qcloud.component.goods.dao.mysql.mapper.MerchandiseMarketingMapper.listAll");
        return list;
    }
    ...
    public MerchandiseMarketing getByUnifiedMerchandise(Long unifiedMerchandiseId) {
        ...
        return sqlOperator.selectOne("com.qcloud.component.goods.dao.mysql.mapper.MerchandiseMarketingMapper.getByUnifiedMerchandise", unifiedMerchandiseId);
    }
    ...
    public boolean update(MerchandiseMarketing merchandiseMarketing, Date lastUpdateTime) {
        ...
        return sqlOperator.update("com.qcloud.component.goods.dao.mysql.mapper.MerchandiseMarketingMapper.update", map) > 0;
    }
    ...
    public boolean setEnable(Long id,int enable) {
        ...
        return sqlOperator.update("com.qcloud.component.goods.dao.mysql.mapper.MerchandiseMarketingMapper.setEnable", map) > 0;
    ...
    public List<MerchandiseMarketing> list(int sence, double discountRange, int start, int count) {
        ...
        List<MerchandiseMarketing> list = sqlOperator.selectList("com.qcloud.component.goods.dao.mysql.mapper.MerchandiseMarketingMapper.list", param);       
        return list;
    }
}
