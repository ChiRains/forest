...
public class MerchandiseSpecificationsRelationDaoCacheImpl implements MerchandiseSpecificationsRelationDao {
    ...
    public MerchandiseSpecificationsRelation get(Long id) {
        ...
        return merchandiseSpecificationsRelationDaoMysqlImpl.get(id);
    }
    ...
    public boolean updateSpecByMap(MerchandiseSpecificationsRelation merchandiseSpecificationsRelation) {
        ...
        return merchandiseSpecificationsRelationDaoMysqlImpl.updateSpecByMap(merchandiseSpecificationsRelation);
    }

    @Override
    public List<MerchandiseSpecificationsRelation> listByMerchandiseId(Long merchandiseId) {

        return merchandiseSpecificationsRelationDaoMysqlImpl.listByMerchandiseId(merchandiseId);
    }

    @Override
    public boolean deleteByMerchandiseId(Long merchandiseIds) {

        return merchandiseSpecificationsRelationDaoMysqlImpl.deleteByMerchandiseId(merchandiseIds);
    }

    @Override
    public List<MerchandiseSpecificationsRelation> listByMap(Long merchandiseId, Long attributeId) {

        return merchandiseSpecificationsRelationDaoMysqlImpl.listByMap(merchandiseId, attributeId);
    }
}
