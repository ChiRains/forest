...
public class MerchandiseDaoMysqlImpl implements MerchandiseDao {
    ...
    public Page<Merchandise> page(int start, int count) {
        ...
        List<Merchandise> list = sqlOperator.selectList("com.qcloud.component.goods.dao.mysql.mapper.MerchandiseMapper.list4page", param);
        int total = sqlOperator.selectOne("com.qcloud.component.goods.dao.mysql.mapper.MerchandiseMapper.count4page", param);
    ...
    public Page<Merchandise> page(MerchandiseQuery query, int start, int count) {
        ...
        List<Merchandise> list = sqlOperator.selectList("com.qcloud.component.goods.dao.mysql.mapper.MerchandiseMapper.list4query", param);
        int total = sqlOperator.selectOne("com.qcloud.component.goods.dao.mysql.mapper.MerchandiseMapper.count4query", param);
        Page<Merchandise> page = new Page<Merchandise>();
        page.setCount(total);
        page.setData(list);
        return page;
    ...
    public List<Merchandise> listAll() {
        ...
        List<Merchandise> list = sqlOperator.selectList("com.qcloud.component.goods.dao.mysql.mapper.MerchandiseMapper.listAll");
        return list;
    }
    ...
    public Page<Merchandise> page(Map<String, Object> map, int start, int count) {
        ...
        map.put("start", start);
        map.put("count", count);
        List<Merchandise> list = sqlOperator.selectList("com.qcloud.component.goods.dao.mysql.mapper.MerchandiseMapper.list4query2", map);
        int total = sqlOperator.selectOne("com.qcloud.component.goods.dao.mysql.mapper.MerchandiseMapper.count4query2", map);
    ...
    public List<Merchandise> merchandiseList(Map<String, Object> map) {
        ...
        List<Merchandise> list = sqlOperator.selectList("com.qcloud.component.goods.dao.mysql.mapper.MerchandiseMapper.listByMap", map);
        return list;
    }
    ...
    public Page<Merchandise> list4MerchandiseState(Map<String, Object> param) {
        ...
        List<Merchandise> list = sqlOperator.selectList("com.qcloud.component.goods.dao.mysql.mapper.MerchandiseMapper.list4MerchandiseState", param);
        int totalCount = 0;
        Page<Merchandise> page = new Page<Merchandise>();
        page.setData(list);
    ...
    public boolean updateMerchandiseState(Map<String, Object> param) {
        ...
        return sqlOperator.update("com.qcloud.component.goods.dao.mysql.mapper.MerchandiseMapper.updateMerchandiseState", param) > 0;
    }

    @Override
    public List<Merchandise> listByName(String name) {

        List<Merchandise> list = sqlOperator.selectList("com.qcloud.component.goods.dao.mysql.mapper.MerchandiseMapper.listByName", name);
        return list;
    }
    ...
    public List<Merchandise> listBySysCode(String code) {
        ...
        List<Merchandise> list = sqlOperator.selectList("com.qcloud.component.goods.dao.mysql.mapper.MerchandiseMapper.listBySysCode", code);
        return list;
    }
    ...
    public List<Merchandise> listByCode(Long merchantId, String code) {
        ...
        param.put("code", code);
        List<Merchandise> list = sqlOperator.selectList("com.qcloud.component.goods.dao.mysql.mapper.MerchandiseMapper.listByCode", param);
        return list;
    }
    ...
    public int count4DeleteClassify(Long mallClassifyId) {
        ...
        return sqlOperator.selectOne("com.qcloud.component.goods.dao.mysql.mapper.MerchandiseMapper.count4Admin", param);
    }
    ...
    public List<Merchandise> getMerchandiseList(long merchantId) {
        ...
        Map<String, Object> param = new HashMap<String, Object>();
        param.put("merchantId", merchantId);
        return sqlOperator.selectList("com.qcloud.component.goods.dao.mysql.mapper.MerchandiseMapper.getMerchandiseList", param);
    }
    ...
    public int countMerchantOnlineNumber(long merchantId) {
        ...
        Map<String, Object> param = new HashMap<String, Object>();
        param.put("merchantId", merchantId);
        return sqlOperator.selectOne("com.qcloud.component.goods.dao.mysql.mapper.MerchandiseMapper.countMerchantOnlineNumber", param);
    }
    ...
    public List<Merchandise> list4Admin(MerchandiseQuery query, int start, int count) {
        ...
        List<Merchandise> list = sqlOperator.selectList("com.qcloud.component.goods.dao.mysql.mapper.MerchandiseMapper.list4Admin", param);
        return list;
    }
