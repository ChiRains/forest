...
public class ClassifySpecificationsDaoMysqlImpl implements ClassifySpecificationsDao {
    ...
    public List<ClassifySpecifications> listByClassify(Long classifyId) {
        List<ClassifySpecifications> list = sqlOperator.selectList(
                "com.qcloud.component.goods.dao.mysql.mapper.ClassifySpecificationsMapper.listByClassify", classifyId);
        return list;
    ...
    public List<ClassifySpecifications> list(HashMap where) {
        return sqlOperator.selectList("com.qcloud.component.goods.dao.mysql.mapper.ClassifySpecificationsMapper.list", where);
    }
    ...
    public ClassifySpecifications get(HashMap where) {
        where.put("start", 0);
        where.put("count", 1);
        return sqlOperator.selectOne("com.qcloud.component.goods.dao.mysql.mapper.ClassifySpecificationsMapper.list", where);
    }
    ...
    public Page<ClassifySpecifications> page(HashMap where, int start, int size) {
        ...
        List<ClassifySpecifications> list = sqlOperator.selectList(
                "com.qcloud.component.goods.dao.mysql.mapper.ClassifySpecificationsMapper.list",
                where);
        int total = sqlOperator.selectOne(
                "com.qcloud.component.goods.dao.mysql.mapper.ClassifySpecificationsMapper.count",
                where);
